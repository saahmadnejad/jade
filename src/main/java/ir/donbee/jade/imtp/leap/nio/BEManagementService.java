...
import ir.donbee.jade.core.sam.CounterValueProvider;
...
import ir.donbee.jade.util.ThreadDumpManager;
...
server in the form of <code>ir.donbee.jade.imtp.leap.JICP.ProtocolManager<code> 
class
</li>
<li>
...
public class BEManagementService extends BaseService {
	...
	private void handleAcceptOption(Profile p) throws ProfileException {
		...
		if (acceptOption != null) {
			...
			ir.donbee.jade.util.leap.List acceptedProtocols = p.getSpecifiers(ACCEPT);
				...
				case JICPProtocol.CREATE_MEDIATOR_TYPE: {
					...
					if (mediator == null) {
						...
						if (id != null) {
							...
							p.setProperty(ir.donbee.jade.core.BackEndContainer.RESYNCH, "true");
						} else {
