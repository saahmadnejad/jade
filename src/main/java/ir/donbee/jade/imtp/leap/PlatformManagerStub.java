...
class PlatformManagerStub extends Stub implements PlatformManager {
	...
	private static final String AUTH_EXCEPTION = "ir.donbee.jade.security.JADESecurityException";
	private static final String SERVICE_EXCEPTION = "ir.donbee.jade.core.ServiceException";
