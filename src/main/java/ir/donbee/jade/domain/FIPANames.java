...
public interface FIPANames {
	 ...
	 * @see <a href=http://www.org/specs/fipa00070/XC00070f.html>FIPA Spec</a>
	 **/
	public static final String STRING = "acl.rep.string.std";
	/** Syntactic representation of ACL in XML form
	 * @see <a href=http://www.org/specs/fipa00071/XC00071b.html>FIPA Spec</a>
	 **/
	public static final String XML = "acl.rep.xml.std";
	/** Syntactic representation of ACL in bit-efficient form
	 * @see <a href=http://www.org/specs/fipa00069/XC00069e.html>FIPA Spec</a>
	 **/
	public static final String BITEFFICIENT = "acl.rep.bitefficient.std"; 
    }
	...
	*/
	...
	/**
	 * IIOP-based MTP
	 * @see <a href=http://www.org/specs/fipa00075/XC00075e.html>FIPA Spec</a>
	 **/
	public static final String IIOP = "mts.mtp.iiop.std";
	/**
	 * WAP-based MTP
	 * @see <a href=http://www.org/specs/fipa00076/XC00076c.html>FIPA Spec</a>
	 **/
	public static final String WAP = "mts.mtp.wap.std";
	/**
	 * HTTP-based MTP
	 * @see <a href=http://www.org/specs/fipa00084/XC00084d.html>FIPA Spec</a>
	 **/
	public static final String HTTP = "mts.mtp.http.std";
    }
}
