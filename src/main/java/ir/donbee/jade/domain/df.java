...
import ir.donbee.jade.core.behaviours.*;

import ir.donbee.jade.domain.FIPAAgentManagement.*;
import ir.donbee.jade.domain.FIPAAgentManagement.InternalError;
import ir.donbee.jade.domain.JADEAgentManagement.*;
import ir.donbee.jade.domain.KBManagement.*;
import ir.donbee.jade.domain.DFGUIManagement.*;
import ir.donbee.jade.domain.DFGUIManagement.GetDescription; // Explicitly imported to avoid conflict with FIPA management ontology
//#PJAVA_EXCLUDE_BEGIN
...
import ir.donbee.jade.gui.GuiAgent;
import ir.donbee.jade.gui.GuiEvent;

import ir.donbee.jade.proto.SubscriptionResponder;
import ir.donbee.jade.proto.AchieveREInitiator;

import ir.donbee.jade.content.*;
import ir.donbee.jade.content.lang.*;
import ir.donbee.jade.content.lang.sl.*;
...
/**
 ...
 a sub class of ir.donbee.jade.domain.DFKBFactory.
 </td>
 </tr>
 <tr>
 <td>
 ...
 <code>
 java ir.donbee.jade.Boot -gui -jade_domain_df_db-url jdbc:odbc:dfdb -jade_domain_df_maxleasetime 3600000
 </code>
 <p>
...
public class df extends GuiAgent implements DFGUIAdapter {
	...
	protected boolean showGui() {
		...
		{
			try{
				Class c = Class.forName("ir.donbee.jade.tools.dfgui.DFGUI");
