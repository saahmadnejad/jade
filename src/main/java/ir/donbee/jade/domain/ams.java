...
import ir.donbee.jade.domain.introspection.*;
import ir.donbee.jade.domain.mobility.*;
...
public class ams extends Agent /*implements AgentManager.Listener*/ {
	...
	protected void setup() {		
		...
		// Use fully qualified name to avoid conflict with old ir.donbee.jade.domain.MobilityOntology
		getContentManager().registerOntology(ir.donbee.jade.domain.mobility.MobilityOntology.getInstance());
		...
		MessageTemplate mtJ = MessageTemplate.and(MessageTemplate.MatchPerformative(ACLMessage.REQUEST), MessageTemplate.or(MessageTemplate.MatchOntology(JADEManagementVocabulary.NAME), MessageTemplate.MatchOntology(ir.donbee.jade.domain.mobility.MobilityOntology.NAME)));
