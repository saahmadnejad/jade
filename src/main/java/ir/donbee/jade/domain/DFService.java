...
import ir.donbee.jade.content.lang.sl.SL0Vocabulary;
import ir.donbee.jade.content.lang.sl.SimpleSLTokenizer;
import ir.donbee.jade.core.AID;
import ir.donbee.jade.core.Agent;
import ir.donbee.jade.core.behaviours.WakerBehaviour;
import ir.donbee.jade.domain.FIPAAgentManagement.DFAgentDescription;
import ir.donbee.jade.domain.FIPAAgentManagement.FIPAManagementVocabulary;
import ir.donbee.jade.domain.FIPAAgentManagement.MissingParameter;
import ir.donbee.jade.domain.FIPAAgentManagement.MultiValueProperty;
import ir.donbee.jade.domain.FIPAAgentManagement.Property;
import ir.donbee.jade.domain.FIPAAgentManagement.SearchConstraints;
import ir.donbee.jade.domain.FIPAAgentManagement.ServiceDescription;
import ir.donbee.jade.lang.acl.ACLMessage;
import ir.donbee.jade.lang.acl.ISO8601;
 ...
 * executed or a ir.donbee.jade.domain.FIPAException exception has been thrown 
 ...
 * non-blocking way. In these cases a <code>ir.donbee.jade.proto.AchieveREInitiator</code>
 * or <code>ir.donbee.jade.proto.SubscriptionInitiator</code> should be used in 
...
public class DFService extends FIPAService {
	...
	/** 
	 ...
	 the <code>ir.donbee.jade.proto.AchieveREInitiator</code> protocol and with
	 ...
	 @see ir.donbee.jade.proto.AchieveREInitiator
	...
	/** 
	 ...
	 <p>
	 This method can be fruitfully used in combination with 
	 the <code>ir.donbee.jade.proto.SubscriptionInitiator</code> protocol and with
	 ...
	 @see ir.donbee.jade.proto.SubscriptionInitiator
