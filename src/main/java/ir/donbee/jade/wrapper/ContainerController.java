...
/**
   ...
   <br>
   @see ir.donbee.jade.core.Runtime#createAgentContainer(Profile)
...
public class ContainerController {
	...
	public AgentController getAgent(String name, boolean isGuid) throws ControllerException {
		...
		ir.donbee.jade.core.Agent instance = myImpl.acquireLocalAgent(agentID);
		if (instance == null) {
	 ...
	 */
	public AgentController acceptNewAgent(String nickname, ir.donbee.jade.core.Agent anAgent) throws StaleProxyException {
		if (myImpl == null || myProxy == null) {
			throw new StaleProxyException();
		}
		...
		try {
			ir.donbee.jade.core.NodeDescriptor nd = myImpl.getNodeDescriptor();
