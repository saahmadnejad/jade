...
This class extends the <code>ir.donbee.jade.core.Agent </code> class: at the start-up 
it instantiate ad ad-hoc behaviour that manages a queue of 
<code>ir.donbee.jade.gui.GuiEvent</code>,event objects that can be received by other threads.  
A thread (in particular a GUI)to notify an event to an Agent should create 
a new Object of type <code>ir.donbee.jade.gui.GuiEvent</code>and pass it as a parameter 
to the call of the method <code>postGuiEvent</code> of the
<code>ir.donbee.jade.gui.GuiAgent</code> object. Notice that an object of type 
...
@see ir.donbee.jade.core.Agent
@see ir.donbee.jade.gui.GuiEvent
