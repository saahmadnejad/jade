...
/** Tests:
 * java ir.donbee.jade.Boot (with/without rmiregistry started): run a main-container
 * java ir.donbee.jade.Boot -host pippo.cselt.it
 * java ir.donbee.jade.Boot -host fbellif.cselt.it
 * java ir.donbee.jade.Boot -host fbellif.cselt.it -port 1200
 * java ir.donbee.jade.Boot -help
 * java ir.donbee.jade.Boot -gui
 **/
package ir.donbee.jade;
...
import ir.donbee.jade.core.Runtime;
import ir.donbee.jade.core.Profile;
//import ir.donbee.jade.core.BootProfileImpl;
import ir.donbee.jade.util.ExtendedProperties;
import ir.donbee.jade.util.PropertiesException;
//import ir.donbee.jade.security.SecurityFactory;
...
public class Boot3 {
    ...
    public Boot3(String[] args) {
        ...
        if (profile.getParameter(Profile.IMTP, null) == null) {
	        profile.setParameter(Profile.IMTP, "ir.donbee.jade.imtp.rmi.RMIIMTPManager");
        }
    ...
    public void usage(PrintStream out) {
        out.println("Usage: java ir.donbee.jade.Boot [options] [agent specifiers]");
        out.println("");
	...
	out.println("  -nomobility\t\tIf specified, disables the mobility and cloning support for the container.");
        ...
        out.println("  \tjava ir.donbee.jade.Boot -container peter:myAgent");
        out.println("");
        out.println("  Connect to a platform on host zork.zot.za, on port 1100,");
        out.println("  starting two agents");
        out.println("  java ir.donbee.jade.Boot -container -host zork.zot.za -port 1100 peter:heAgent paula:sheAgent");
        out.println("");
        out.println("  Create an Agent Platform and starts an agent on the local Agent Container");
        out.println("  \tjava ir.donbee.jade.Boot Willy:searchAgent");
        out.println("");
        System.exit(0);
    }
