...
public class HashMap implements Map, Serializable {
    ...
    /**
     * @see ir.donbee.jade.util.leap.Map interface
     */
    ...
    public Set keySet() {
        if (keySet == null) {
            keySet = new Set() {
                ...
                /**
                 * @see ir.donbee.jade.util.leap.Set interface
                 */
                ...
                public Iterator iterator() {
                    return new Iterator() {
                        ...
                        /**
                         * @see ir.donbee.jade.util.leap.Iterator interface
                         */
    ...
    public Collection values() {
        if (values == null) {
            values = new Collection() {
                ...
                /**
                 * @see ir.donbee.jade.util.leap.Collection interface
                 */
                public Object[] toArray() {
