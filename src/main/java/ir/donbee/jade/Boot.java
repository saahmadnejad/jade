...
public class Boot {
	...
	private static Logger logger = Logger.getMyLogger("ir.donbee.jadeBoot");
	...
	public static void main(String args[]) {
		try {
			...
			pe.printStackTrace();
			printUsage();
			//System.err.println("Usage: java ir.donbee.jadeBoot <filename>");
			System.exit(-1);
		}
	...
	public static void printUsage() {
		...
		System.out.println("java -cp <classpath> ir.donbee.jadeBoot [options] [agents]");
