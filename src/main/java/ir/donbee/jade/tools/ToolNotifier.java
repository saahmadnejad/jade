...
import ir.donbee.jade.core.event.MessageEvent;
import ir.donbee.jade.core.event.MessageListener;
import ir.donbee.jade.core.event.AgentEvent;
import ir.donbee.jade.core.event.AgentListener;
import ir.donbee.jade.core.event.NotificationHelper;
import ir.donbee.jade.core.event.NotificationService;
	...
	public void sentMessage(MessageEvent ev) {
		if (state == ACTIVE_STATE) {
			...
			if(observedAgents.contains(sender)) {
				...
				ir.donbee.jade.domain.introspection.ACLMessage m = new ir.donbee.jade.domain.introspection.ACLMessage();
