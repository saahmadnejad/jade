...
package ir.donbee.jade.tools.dfgui;
...
import ir.donbee.jade.domain.*;
import ir.donbee.jade.domain.FIPAAgentManagement.DFAgentDescription;
import ir.donbee.jade.core.AID;
import ir.donbee.jade.domain.DFGUIAdapter;
import ir.donbee.jade.gui.AboutJadeAction;
import ir.donbee.jade.gui.JadeLogoButton;
...
*/
	...
	* @see ir.donbee.jade.tools.dfgui#removeSearchResult(AID name)
	*/
  ...
  */
	...
	* @see ir.donbee.jade.domain.FIPAAgentManagement.DFAgentDescription
	* @see ir.donbee.jade.core.AID
	*/
