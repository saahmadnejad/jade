...
package ir.donbee.jade.tools.introspector;
...
import ir.donbee.jade.domain.FIPAService;
import ir.donbee.jade.domain.introspection.*;

import ir.donbee.jade.domain.JADEAgentManagement.JADEManagementOntology;
import ir.donbee.jade.domain.JADEAgentManagement.DebugOn;
import ir.donbee.jade.domain.JADEAgentManagement.DebugOff;
...
import ir.donbee.jade.tools.introspector.gui.IntrospectorGUI;
import ir.donbee.jade.tools.introspector.gui.MainWindow;
...
public class Introspector extends ToolAgent {
	...
	public void toolSetup() {
		...
		addBehaviour(new SensorManager(this, guiSensor) {
			public void onEvent(ir.donbee.jade.util.Event ev) {
