...
/**
   ...
   @version $Date: 2003-12-23 14:54:01 +0100 (mar, 23 dic 2003) $ $Revision: 4735 $
 */
class PopupMenuAgent extends JPopupMenu{
 public PopupMenuAgent(ActionProcessor actPro) {
  super();
   ...
   tmp=add((RMAAction)actPro.actions.get(actPro.SAVEAGENT_ACTION));
   tmp.setIcon(null);

   tmp=add((RMAAction)actPro.actions.get(actPro.FREEZEAGENT_ACTION));
   tmp.setIcon(null);
