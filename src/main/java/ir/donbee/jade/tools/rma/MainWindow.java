...
import ir.donbee.jade.gui.GuiProperties;
import ir.donbee.jade.gui.APDescriptionPanel;
...
class MainWindow extends JFrame {
	...
	public void showErrorDialog(String text, ACLMessage msg) {
		...
		case JOptionPane.YES_OPTION:
			ir.donbee.jade.gui.AclGui.showMsgInDialog(msg, this);
			break;
		default:
			break;
		}
	...
	public boolean showInstallMTPDialog(ir.donbee.jade.domain.JADEAgentManagement.InstallMTP imtp) {
	...
	public boolean showUninstallMTPDialog(ir.donbee.jade.domain.JADEAgentManagement.UninstallMTP umtp) {
