...
package ir.donbee.jade.tools.rma;
...
import ir.donbee.jade.domain.persistence.*;
import ir.donbee.jade.domain.mobility.*;
import ir.donbee.jade.domain.FIPANames;
import ir.donbee.jade.gui.AgentTreeModel;
...
import ir.donbee.jade.proto.SimpleAchieveREInitiator;

import ir.donbee.jade.tools.ToolAgent;
...
public class rma extends ToolAgent {
	...
	public void newAgent(String agentName, String className, Object arg[], String ownerName, String containerName) {
		...
		ir.donbee.jade.security.JADEPrincipal intendedOwner = null;
		ir.donbee.jade.security.Credentials initialCredentials = null;
		
		if ((ownerName==null) || (ownerName.trim().length()==0)) {
			// it is requested the creation of an agent 
			// with the same owner of the RMA
			try {
				ir.donbee.jade.security.JADEPrincipal rmaOwner = null;
				ir.donbee.jade.security.Credentials rmaCredentials = null;
			...
			try
			{
				Class c = Class.forName("ir.donbee.jade.security.impl.JADEPrincipalImpl");
