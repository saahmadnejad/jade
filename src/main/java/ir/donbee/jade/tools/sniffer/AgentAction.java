...
/**
   ...
   @version $Date: 2001-05-17 15:17:15 +0200 (gio, 17 mag 2001) $ $Revision: 2257 $
 */

 /**
 * This class is useful to represent the actions that must perform
 * with the agents.
 * @see    ir.donbee.jade.tools.sniffer.FixedAction
 * @see    ir.donbee.jade.tools.sniffer.SnifferAction
 */
