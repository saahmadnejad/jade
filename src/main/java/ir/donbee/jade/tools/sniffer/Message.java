 ...
 * ir.donbee.jade.lang.acl.ACLMessage) providing an ACLMessage with the graphic part: the
...
public class Message extends ACLMessage implements Serializable {
  ...
  public Message(ACLMessage msg, AID r) {
    ...
    for (ir.donbee.jade.util.leap.Iterator i=msg.getAllReceiver(); i.hasNext(); )
	#DOTNET_INCLUDE_END*/
	...
	//#DOTNET_EXCLUDE_END
	/*#DOTNET_INCLUDE_BEGIN
    for (ir.donbee.jade.util.leap.Iterator i=msg.getAllReplyTo(); i.hasNext(); )
	#DOTNET_INCLUDE_END*/
