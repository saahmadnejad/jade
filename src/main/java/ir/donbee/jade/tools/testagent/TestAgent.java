 ...
 * ***************************************************************/
package ir.donbee.jade.tools.testagent;
...
import ir.donbee.jade.domain.FIPAAgentManagement.FIPAManagementOntology;
...
public class TestAgent extends Agent {
  ...
  public static void main(String[] args) {
    ...
    String argsv[] = {"-host", host, "-container", "ruurd:ir.donbee.jade.tools.testagent.TestAgent"};
    ir.donbee.jade.Boot3.main(argsv);
  }
  ...
  public void doRegisterDF() {
    ...
    serviceDescr.setType("ir.donbee.jade.testagent");
  ...
  ACLMessage createRequestMessage(Agent sender, AID receiver, AgentAction what) {
    ...
    ir.donbee.jade.content.onto.basic.Action act = new ir.donbee.jade.content.onto.basic.Action();
