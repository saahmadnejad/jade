...
import ir.donbee.jade.content.schema.ReferenceSchema;
import ir.donbee.jade.content.schema.VariableSchema;
...
//		}
	...
	public static Class getJavaClass() {
		if (absReferenceClass == null) {
			try {
				absReferenceClass = Class.forName("ir.donbee.jade.content.abs.AbsReference");
			}
			catch (Exception e) {
				// Should never happen
				e.printStackTrace();
