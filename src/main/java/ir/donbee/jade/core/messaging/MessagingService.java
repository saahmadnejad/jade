...
import ir.donbee.jade.core.HorizontalCommand;
import ir.donbee.jade.core.VerticalCommand;
import ir.donbee.jade.core.GenericCommand;
import ir.donbee.jade.core.Service;
import ir.donbee.jade.core.BaseService;
import ir.donbee.jade.core.ServiceException;
import ir.donbee.jade.core.Sink;
import ir.donbee.jade.core.Filter;
import ir.donbee.jade.core.Node;
import ir.donbee.jade.core.AgentContainer;
import ir.donbee.jade.core.MainContainer;
import ir.donbee.jade.core.CaseInsensitiveString;
...
import ir.donbee.jade.core.ServiceNotActiveException;
import ir.donbee.jade.core.Specifier;
import ir.donbee.jade.core.ProfileException;
import ir.donbee.jade.core.IMTPException;
import ir.donbee.jade.core.NotFoundException;
import ir.donbee.jade.core.replication.MainReplicationHandle;
//#J2ME_EXCLUDE_BEGIN
import ir.donbee.jade.core.sam.AbsoluteCounterValueProvider;
import ir.donbee.jade.core.sam.AverageMeasureProviderImpl;
import ir.donbee.jade.core.sam.MeasureProvider;
import ir.donbee.jade.core.sam.MediatedMeasureProvider;
import ir.donbee.jade.core.sam.SAMHelper;
//#J2ME_EXCLUDE_END
...
import ir.donbee.jade.lang.acl.ACLCodec;
import ir.donbee.jade.lang.acl.LEAPACLCodec;
import ir.donbee.jade.lang.acl.StringACLCodec;
...
import ir.donbee.jade.util.HashCache;
...
public class MessagingService extends BaseService implements MessageManager.Channel {
	...
	public void boot(Profile myProfile) throws ServiceException {
		...
		try {
			...
			while (codecs.hasNext()) {
				...
				try{
					...
					throw new ir.donbee.jade.lang.acl.ACLCodec.CodecException("ERROR: The class " +className +" for the ACLCodec not found.", cnfe);
				}
				catch(InstantiationException ie) {
					throw new ir.donbee.jade.lang.acl.ACLCodec.CodecException("The class " + className + " raised InstantiationException (see NestedException)", ie);
				}
				catch(IllegalAccessException iae) {
					throw new ir.donbee.jade.lang.acl.ACLCodec.CodecException("The class " + className  + " raised IllegalAccessException (see nested exception)", iae);
				}
			}
		...
		catch(ir.donbee.jade.lang.acl.ACLCodec.CodecException ce) {
...
//		stopSAM();
		...
		List platformAddresses = new ir.donbee.jade.util.leap.ArrayList();
	 ...
	 * @see ir.donbee.jade.core.ServiceFinder
	 */
	 ...
	 *
	 * @see ir.donbee.jade.core.Service#getCommandSink()
	 */
