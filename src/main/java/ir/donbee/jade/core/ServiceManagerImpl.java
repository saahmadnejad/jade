...
public class ServiceManagerImpl implements ServiceManager, ServiceFinder {
	...
	private ir.donbee.jade.util.Logger myLogger;
	 ...
	 * @see ir.donbee.jade.core.faultRecovery.FaultRecoveryService
	 */
	 ...
	 * @see ir.donbee.jade.core.replication.MainReplicationService
	 */
