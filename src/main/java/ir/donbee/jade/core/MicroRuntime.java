...
public class MicroRuntime {
	...
	//#J2ME_EXCLUDE_END
	/*#J2ME_INCLUDE_BEGIN
	private static Logger logger = Logger.getJADELogger("ir.donbee.jade.core.MicroRuntime");
	#J2ME_INCLUDE_END*/
	...
	public static AgentController getAgent(String localName) throws ControllerException {
		...
		ir.donbee.jade.core.Agent instance = myFrontEnd.getLocalAgent(localName);
		if (instance == null) {
