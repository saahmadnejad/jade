...
import ir.donbee.jade.core.behaviours.OneShotBehaviour;
import ir.donbee.jade.core.management.AgentManagementSlice;
import ir.donbee.jade.core.messaging.GenericMessage;
import ir.donbee.jade.core.messaging.MessagingService;
import ir.donbee.jade.core.messaging.MessagingSlice;
import ir.donbee.jade.core.mobility.AgentMobilityHelper;
import ir.donbee.jade.core.mobility.AgentMobilityService;
import ir.donbee.jade.domain.AMSService;
		...
		public final boolean accept(VerticalCommand cmd) {
			...
			if (name.equals(MessagingSlice.SEND_MESSAGE)) {
				...
				if (info != null) {
					...
					// ir.donbee.jade.core.messaging.OutBox.addLast())
