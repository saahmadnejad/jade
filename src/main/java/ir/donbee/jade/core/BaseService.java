...
public abstract class BaseService implements Service {
	...
	public void init(AgentContainer ac, Profile p) throws ProfileException {
		...
		myLogger.log(ir.donbee.jade.util.Logger.INFO, "Service "+getName()+" initialized");
	}
	...
	// from accessing the Command Processor (they are less trusted than ir.donbee.jade.core).
