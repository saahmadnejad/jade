...
import ir.donbee.jade.core.nodeMonitoring.NodeMonitoringService;
import ir.donbee.jade.core.nodeMonitoring.UDPNodeMonitoringService;
import ir.donbee.jade.core.replication.MainReplicationService;
...
public class FaultRecoveryService extends BaseService {
	...
	public static final String PERSISTENT_STORAGE_CLASS_DEFAULT = "ir.donbee.jade.core.faultRecovery.FSPersistentStorage";
