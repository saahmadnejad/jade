...
import ir.donbee.jade.core.BehaviourID;
import ir.donbee.jade.core.AgentState;
import ir.donbee.jade.core.Channel;
...
import ir.donbee.jade.tools.ToolNotifier;
import ir.donbee.jade.util.SynchList;
...
public class NotificationService extends BaseService {
	 ...
	 */
	public static final String NAME = "ir.donbee.jade.core.event.Notification";
	...
	private class NotificationOutgoingFilter extends Filter {
		public boolean accept(VerticalCommand cmd) {		
			try {
				String name = cmd.getName();
				if(name.equals(ir.donbee.jade.core.messaging.MessagingSlice.SEND_MESSAGE)) {
					handleSendMessage(cmd);
				}
				else if(name.equals(ir.donbee.jade.core.management.AgentManagementSlice.INFORM_CREATED)) {
				...
				else if(name.equals(ir.donbee.jade.core.replication.MainReplicationSlice.LEADERSHIP_ACQUIRED)) {
	...
	private class NotificationIncomingFilter extends Filter {
		...
		public void postProcess(VerticalCommand cmd) {		
			try {
				String name = cmd.getName();
				if(name.equals(ir.donbee.jade.core.Service.REATTACHED)) {
					handleReattached(cmd);
				}
				else if(name.equals(ir.donbee.jade.core.Service.RECONNECTED)) {
