...
public class PlatformID implements Location {
	...
	/* (non-Javadoc)
	 * @see ir.donbee.jade.core.Location#getID()
	 */
	public String getID() {
	...
	/* (non-Javadoc)
	 * @see ir.donbee.jade.core.Location#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see ir.donbee.jade.core.Location#getProtocol()
	 */
	...
	/* (non-Javadoc)
	 * @see ir.donbee.jade.core.Location#getAddress()
	 */
