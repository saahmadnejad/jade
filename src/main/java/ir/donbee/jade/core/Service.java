...
public interface Service {
	...
	public interface Slice extends Serializable {
	   ...
	   @see ir.donbee.jade.core.Service#getSlice(String name)
		 */
		Service getService();
	...
	/**
       ...
       supporting routed dispatching of horizontal commands.
			 @deprecated use the class ir.donbee.jade.core.SliceProxy instead of this inner class
	 */
	public class SliceProxy extends ir.donbee.jade.core.SliceProxy implements Slice {
	...
	/**
       ...
       @see ir.donbee.jade.core.Service#getOwnedCommands()
	 */
