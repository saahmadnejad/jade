...
import ir.donbee.jade.core.ServiceFinder;
...
import ir.donbee.jade.core.BackEndContainer;
...
import ir.donbee.jade.core.UnreachableException;
...
public class BEAgentManagementService extends BaseService {
	...
	static final String NAME = "ir.donbee.jade.core.management.AgentManagement";
		...
		private void handleInformCreated(VerticalCommand cmd) throws IMTPException, NotFoundException, NameClashException, JADESecurityException, ServiceException {
			...
			try {
				...
				try {
					...
					mainSlice = (AgentManagementSlice)getFreshSlice(ir.donbee.jade.core.ServiceFinder.MAIN_SLICE);
					mainSlice.bornAgent(agentID, cid, cmd);
				}
			}
			catch (IMTPException imtpe) {
