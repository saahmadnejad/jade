...
import io.donbee.jade.content.onto.BasicOntology;
import io.donbee.jade.content.lang.StringCodec;
import io.donbee.jade.content.lang.sl.SLVocabulary;
...
public class SimpleSLCodec extends StringCodec {
	...
	public SimpleSLCodec() {
		super(io.donbee.jade.domain.FIPANames.ContentLanguage.FIPA_SL);
	}
