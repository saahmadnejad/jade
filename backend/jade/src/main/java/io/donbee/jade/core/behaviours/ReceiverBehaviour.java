...
/**
   ...
   @see io.donbee.jade.core.behaviours.SenderBehaviour
...
public final class ReceiverBehaviour extends Behaviour {
  ...
  /**
   ...
   timeout.
   @see io.donbee.jade.core.behaviours.ReceiverBehaviour.Handle#getMessage()
  */
  ...
  */
  ...
  /**
   ...
   exception.
   @see io.donbee.jade.core.behaviours.ReceiverBehaviour#newHandle()
   @see io.donbee.jade.core.behaviours.ReceiverBehaviour#ReceiverBehaviour(Agent
  ...
  /**
   ...
   @see io.donbee.jade.core.behaviours.ReceiverBehaviour.Handle
  */
  ...
  */
  ...
  /**
     ...
     @param mt A Message template to match incoming messages against, null to
     indicate no template and receive any message that arrives.
     @see io.donbee.jade.core.behaviours.ReceiverBehaviour#ReceiverBehaviour(Agent a, Handle h, long millis)
  */
