...
public class ACLSLTokenMarker {
  ...
  private static KeywordMap getKeywords() {
    if (aclSLKeywords == null) {
      ...
      io.donbee.jade.util.leap.List agentMgt = FIPAAgentManagementOntology.instance().getVocabulary();
	  ...
	  /* FIXME Need new method to get a vocabulary from an ontology
      io.donbee.jade.util.leap.List li = BasicOntology.instance().getVocabulary();
