...
import io.donbee.jade.domain.FIPAService;
import io.donbee.jade.domain.introspection.*;

import io.donbee.jade.domain.JADEAgentManagement.JADEManagementOntology;
import io.donbee.jade.domain.JADEAgentManagement.DebugOn;
import io.donbee.jade.domain.JADEAgentManagement.DebugOff;
...
import io.donbee.jade.content.onto.basic.Done;
...
import io.donbee.jade.tools.introspector.gui.IntrospectorGUI;
import io.donbee.jade.tools.introspector.gui.MainWindow;
...
public class Introspector extends ToolAgent {
	...
	public void toolSetup() {
		...
		addBehaviour(new SensorManager(this, guiSensor) {
			public void onEvent(io.donbee.jade.util.Event ev) {
