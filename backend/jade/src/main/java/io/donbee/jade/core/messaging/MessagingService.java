...
import io.donbee.jade.core.HorizontalCommand;
import io.donbee.jade.core.VerticalCommand;
import io.donbee.jade.core.GenericCommand;
import io.donbee.jade.core.Service;
import io.donbee.jade.core.BaseService;
import io.donbee.jade.core.ServiceException;
import io.donbee.jade.core.Sink;
import io.donbee.jade.core.Filter;
import io.donbee.jade.core.Node;
import io.donbee.jade.core.AgentContainer;
import io.donbee.jade.core.MainContainer;
import io.donbee.jade.core.CaseInsensitiveString;
...
import io.donbee.jade.core.ServiceNotActiveException;
import io.donbee.jade.core.Specifier;
import io.donbee.jade.core.ProfileException;
import io.donbee.jade.core.IMTPException;
import io.donbee.jade.core.NotFoundException;
import io.donbee.jade.core.replication.MainReplicationHandle;
//#J2ME_EXCLUDE_BEGIN
import io.donbee.jade.core.sam.AbsoluteCounterValueProvider;
import io.donbee.jade.core.sam.AverageMeasureProviderImpl;
import io.donbee.jade.core.sam.MeasureProvider;
import io.donbee.jade.core.sam.MediatedMeasureProvider;
import io.donbee.jade.core.sam.SAMHelper;
//#J2ME_EXCLUDE_END

import io.donbee.jade.domain.FIPANames;
import io.donbee.jade.domain.FIPAAgentManagement.InternalError;
import io.donbee.jade.domain.FIPAAgentManagement.Envelope;
import io.donbee.jade.domain.FIPAAgentManagement.Property;
import io.donbee.jade.domain.FIPAAgentManagement.ReceivedObject;
import io.donbee.jade.security.JADESecurityException;
import io.donbee.jade.lang.acl.ACLMessage;
import io.donbee.jade.lang.acl.ACLCodec;
import io.donbee.jade.lang.acl.LEAPACLCodec;
import io.donbee.jade.lang.acl.StringACLCodec;
import io.donbee.jade.mtp.MTP;
import io.donbee.jade.mtp.MTPDescriptor;
import io.donbee.jade.mtp.MTPException;
import io.donbee.jade.mtp.InChannel;
...
import io.donbee.jade.util.HashCache;
...
public class MessagingService extends BaseService implements MessageManager.Channel {
	...
	public void boot(Profile myProfile) throws ServiceException {
		...
		try {
			...
			while (codecs.hasNext()) {
				...
				try{
					...
					throw new io.donbee.jade.lang.acl.ACLCodec.CodecException("ERROR: The class " +className +" for the ACLCodec not found.", cnfe);
				}
				catch(InstantiationException ie) {
					throw new io.donbee.jade.lang.acl.ACLCodec.CodecException("The class " + className + " raised InstantiationException (see NestedException)", ie);
				}
				catch(IllegalAccessException iae) {
					throw new io.donbee.jade.lang.acl.ACLCodec.CodecException("The class " + className  + " raised IllegalAccessException (see nested exception)", iae);
				}
			}
		...
		catch(io.donbee.jade.lang.acl.ACLCodec.CodecException ce) {
...
//		stopSAM();
		...
		List platformAddresses = new io.donbee.jade.util.leap.ArrayList();
	 ...
	 * @see io.donbee.jade.core.ServiceFinder
	 */
	 ...
	 *
	 * @see io.donbee.jade.core.Service#getCommandSink()
	 */
