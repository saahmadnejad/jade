...
public interface AgentController {
	...
	/**
	     ...
	     @see io.donbee.jade.wrapper.Agent#putO2AObject(Object, boolean)
	 */
	public static final boolean ASYNC = false;
	/**
	     Constant representing a synchronous rendez-vous policy.
	     @see io.donbee.jade.wrapper.Agent#putO2AObject(Object o, boolean blocking)
	 */
	...
	/**
	     ...
	     <code>io.donbee.jade.core.Agent.getO2AObject()</code> method. The agent
	     ...
	     @see io.donbee.jade.core.Agent#getO2AObject()
	 ...
	 * @see io.donbee.jade.core.Agent#registerO2AInterface(Class<T> theClass, T theInterface)
	 */
