...
import io.donbee.jade.content.ContentElementList;
...
to specify additional search constraints.
  ...
  @see io.donbee.jade.domain.DFService
  @see io.donbee.jade.domain.AMSService
...
public class RequestFIPAServiceBehaviour extends SimpleAchieveREInitiator{
  ...
  *  @see io.donbee.jade.domain.FIPAAgentManagement.SearchConstraints
  */
