 ...
 * **************************************************************
 */
package io.donbee.jade.content.onto;

import java.util.Hashtable;
import java.util.Enumeration;

import io.donbee.jade.content.Concept;
import io.donbee.jade.content.abs.AbsAggregate;
import io.donbee.jade.content.abs.AbsHelper;
import io.donbee.jade.content.abs.AbsObject;
import io.donbee.jade.content.schema.AggregateSchema;
import io.donbee.jade.content.schema.ConceptSlotFunctionSchema;
import io.donbee.jade.content.schema.ObjectSchema;
import io.donbee.jade.content.schema.AgentActionSchema;
import io.donbee.jade.content.schema.ConceptSchema;
import io.donbee.jade.content.schema.PredicateSchema;
...
import io.donbee.jade.content.schema.Facet;
import io.donbee.jade.content.schema.facets.CardinalityFacet;
import io.donbee.jade.content.schema.facets.DefaultValueFacet;
import io.donbee.jade.content.schema.facets.PermittedValuesFacet;
import io.donbee.jade.content.schema.facets.RegexFacet;
//#J2ME_EXCLUDE_END
 ...
 * @see io.donbee.jade.content.Concept
 * @see io.donbee.jade.content.abs.AbsConcept
 * @see io.donbee.jade.content.schema.ConceptSchema
 * @see io.donbee.jade.content.onto.BasicOntology
 * @author Federico Bergenti - Universita` di Parma
 * @author Giovanni Caire - TILAB
 */
public class Ontology implements Serializable {
	private static final String DEFAULT_INTROSPECTOR_CLASS = "io.donbee.jade.content.onto.ReflectiveIntrospector";
	...
	static {
		try {
			absObjectClass = Class.forName("io.donbee.jade.content.abs.AbsObject");
		}
		catch (Exception e) {
			// Should never happen
			e.printStackTrace();
