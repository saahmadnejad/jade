...
import io.donbee.jade.core.behaviours.*;

import io.donbee.jade.domain.FIPAAgentManagement.*;
import io.donbee.jade.domain.FIPAAgentManagement.InternalError;
import io.donbee.jade.domain.JADEAgentManagement.*;
import io.donbee.jade.domain.KBManagement.*;
import io.donbee.jade.domain.DFGUIManagement.*;
import io.donbee.jade.domain.DFGUIManagement.GetDescription; // Explicitly imported to avoid conflict with FIPA management ontology
//#PJAVA_EXCLUDE_BEGIN
import io.donbee.jade.domain.introspection.AMSSubscriber;
import io.donbee.jade.domain.introspection.Event;
import io.donbee.jade.domain.introspection.IntrospectionVocabulary;
import io.donbee.jade.domain.introspection.DeadAgent;
//#PJAVA_EXCLUDE_END

import io.donbee.jade.lang.acl.ACLMessage;
import io.donbee.jade.lang.acl.MessageTemplate;
import io.donbee.jade.lang.acl.ISO8601;

import io.donbee.jade.gui.GuiAgent;
import io.donbee.jade.gui.GuiEvent;

import io.donbee.jade.proto.SubscriptionResponder;
import io.donbee.jade.proto.AchieveREInitiator;

import io.donbee.jade.content.*;
import io.donbee.jade.content.lang.*;
import io.donbee.jade.content.lang.sl.*;
import io.donbee.jade.content.onto.basic.*;
...
/**
 ...
 a sub class of io.donbee.jade.domain.DFKBFactory.
 </td>
 </tr>
 <tr>
 <td>
 ...
 <code>
 java io.donbee.jade.Boot -gui -jade_domain_df_db-url jdbc:odbc:dfdb -jade_domain_df_maxleasetime 3600000
 </code>
 <p>
 ...
 @version $Date: 2016-01-25 08:45:38 +0100 (lun, 25 gen 2016) $ $Revision: 6789 $
 */
public class df extends GuiAgent implements DFGUIAdapter {
	...
	private HashCache searchIdCache = new HashCache(SEARCH_ID_CACHE_SIZE);
	...
	protected boolean showGui() {
		...
		{
			try{
				Class c = Class.forName("io.donbee.jade.tools.dfgui.DFGUI");
