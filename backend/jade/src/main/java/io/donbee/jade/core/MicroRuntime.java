...
public class MicroRuntime {
	...
	//#J2ME_EXCLUDE_END
	/*#J2ME_INCLUDE_BEGIN
	private static Logger logger = Logger.getJADELogger("io.donbee.jade.core.MicroRuntime");
	#J2ME_INCLUDE_END*/
	...
	public static AgentController getAgent(String localName) throws ControllerException {
		...
		io.donbee.jade.core.Agent instance = myFrontEnd.getLocalAgent(localName);
		if (instance == null) {
