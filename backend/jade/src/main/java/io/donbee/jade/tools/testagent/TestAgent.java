...
public class TestAgent extends Agent {
  ...
  public static void main(String[] args) {
    ...
    String argsv[] = {"-host", host, "-container", "ruurd:io.donbee.jade.tools.testagent.TestAgent"};
    io.donbee.jade.Boot3.main(argsv);
  }
  ...
  public void doRegisterDF() {
    ...
    serviceDescr.setType("io.donbee.jade.testagent");
  ...
  ACLMessage createRequestMessage(Agent sender, AID receiver, AgentAction what) {
    ...
    io.donbee.jade.content.onto.basic.Action act = new io.donbee.jade.content.onto.basic.Action();
