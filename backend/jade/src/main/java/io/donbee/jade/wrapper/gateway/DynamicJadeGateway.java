...
import io.donbee.jade.util.Event;
import io.donbee.jade.util.Logger;
import io.donbee.jade.util.leap.Properties;
import io.donbee.jade.wrapper.AgentController;
import io.donbee.jade.wrapper.ContainerController;
import io.donbee.jade.wrapper.ControllerException;
import io.donbee.jade.wrapper.StaleProxyException;
...
public class DynamicJadeGateway {
	 ...
	 * @see io.donbee.jade.wrapper.AgentController#putO2AObject(Object, boolean)
	 **/
	 ...
	 * @param jadeProfile the properties that contain all parameters for running JADE (see io.donbee.jade.core.Profile).
