 ...
 * ***************************************************************/
package io.donbee.jade.tools.gui;
...
public class ACLTracePanel extends JPanel {
  ...
  public void addMessageNode(String direction, String theTime, ACLMessage theACL) {
    ...
    io.donbee.jade.util.leap.Properties prop = theACL.getAllUserDefinedParameters();
    if (prop.size() > 0) {
...
//  ***EOF***
  ...
  private class AboutFrame extends JWindow {
    ...
    private void jbInit() throws Exception {
      ...
      border1 = new TitledBorder(BorderFactory.createLineBorder(new Color(0, 0, 128), 1), "io.donbee.jade.tools.gui");
