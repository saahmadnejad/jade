...
public class HashMap implements Map, Serializable {
    ...
    /**
     * @see io.donbee.jade.util.leap.Map interface
     */
    ...
    public Set keySet() {
        if (keySet == null) {
            keySet = new Set() {
                ...
                /**
                 * @see io.donbee.jade.util.leap.Set interface
                 */
                ...
                public Iterator iterator() {
                    return new Iterator() {
                        ...
                        /**
                         * @see io.donbee.jade.util.leap.Iterator interface
                         */
    ...
    public Collection values() {
        if (values == null) {
            values = new Collection() {
                ...
                /**
                 * @see io.donbee.jade.util.leap.Collection interface
                 */
                public Object[] toArray() {
