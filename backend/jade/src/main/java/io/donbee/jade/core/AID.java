...
import io.donbee.jade.util.leap.Comparable;
/*#MIDP_INCLUDE_BEGIN
...
public class AID implements Comparable, Serializable {
	 ...
	 * @see io.donbee.jade.util.leap.Iterator
	 */
	 ...
	 * @return all the user-defined slots as a <code>io.donbee.jade.util.leap.Properties</code> java Object.
	 * @see io.donbee.jade.util.leap.Properties
	 */
	...
	public String toString() {
		...
		//#MIDP_EXCLUDE_BEGIN
		io.donbee.jade.lang.acl.StringACLCodec.appendACLExpression(s,":name",name);
		//#MIDP_EXCLUDE_END
		/*#MIDP_INCLUDE_BEGIN
		 s.append(":name ");
		...
		while (e.hasMoreElements()) {
			...
			s.append(" :X-");
			//#MIDP_EXCLUDE_BEGIN
			io.donbee.jade.lang.acl.StringACLCodec.appendACLExpression(s,key,value);
			//#MIDP_EXCLUDE_END
			/*#MIDP_INCLUDE_BEGIN
			 s.append(key); 
			 s.append(" ");
