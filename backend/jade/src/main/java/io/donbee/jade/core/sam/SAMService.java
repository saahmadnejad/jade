...
package io.donbee.jade.core.sam;
...
import io.donbee.jade.core.replication.MainReplicationSlice;
...
public class SAMService extends BaseService {
	...
	public static final String SAM_INFO_HANDLERS_DEFAULT = "io.donbee.jade.core.sam.DefaultSAMInfoHandlerImpl";
	...
	public void boot(Profile p) throws ServiceException {
		...
		try {
			io.donbee.jade.util.leap.List specs = myProfile.getSpecifiers(AGENTS_TO_MONITOR);
			if (specs != null) {
				io.donbee.jade.util.leap.Iterator it = specs.iterator();
				while (it.hasNext()) {
