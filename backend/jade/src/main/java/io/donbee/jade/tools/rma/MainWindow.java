...
import io.donbee.jade.gui.GuiProperties;
import io.donbee.jade.gui.APDescriptionPanel;
...
class MainWindow extends JFrame {
	...
	public void showErrorDialog(String text, ACLMessage msg) {
		...
		case JOptionPane.YES_OPTION:
			io.donbee.jade.gui.AclGui.showMsgInDialog(msg, this);
			break;
		default:
			break;
		}
	...
	public boolean showInstallMTPDialog(io.donbee.jade.domain.JADEAgentManagement.InstallMTP imtp) {
	...
	public boolean showUninstallMTPDialog(io.donbee.jade.domain.JADEAgentManagement.UninstallMTP umtp) {
