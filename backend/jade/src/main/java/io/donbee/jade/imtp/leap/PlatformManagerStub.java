...
class PlatformManagerStub extends Stub implements PlatformManager {
	...
	private static final String AUTH_EXCEPTION = "io.donbee.jade.security.JADESecurityException";
	private static final String SERVICE_EXCEPTION = "io.donbee.jade.core.ServiceException";
