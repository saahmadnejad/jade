...
public class AgentState {
    ...
    */
	...
	//#MIDP_EXCLUDE_BEGIN
	new AgentState("Transit", io.donbee.jade.core.mobility.AgentMobilityService.AP_TRANSIT),
	new AgentState("Copy", io.donbee.jade.core.mobility.AgentMobilityService.AP_COPY),
	new AgentState("Gone", io.donbee.jade.core.mobility.AgentMobilityService.AP_GONE),
