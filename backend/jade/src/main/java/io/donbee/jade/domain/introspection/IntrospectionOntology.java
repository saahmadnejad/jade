...
import io.donbee.jade.domain.FIPAAgentManagement.ExceptionOntology;
import io.donbee.jade.domain.FIPAAgentManagement.ReceivedObject;
import io.donbee.jade.domain.FIPAAgentManagement.APDescription;
import io.donbee.jade.domain.FIPAAgentManagement.APService;
...
public class IntrospectionOntology extends Ontology implements IntrospectionVocabulary {
	...
	private IntrospectionOntology() {
		...
		try {
			...
			cs.add(BORNAGENT_CLONE_ORIGINATOR, (PrimitiveSchema)getSchema(BasicOntology.STRING), ObjectSchema.OPTIONAL);
