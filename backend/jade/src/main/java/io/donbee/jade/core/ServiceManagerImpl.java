...
public class ServiceManagerImpl implements ServiceManager, ServiceFinder {
	...
	private io.donbee.jade.util.Logger myLogger;
	 ...
	 * @see io.donbee.jade.core.faultRecovery.FaultRecoveryService
	 */
	 ...
	 * @see io.donbee.jade.core.replication.MainReplicationService
	 */
