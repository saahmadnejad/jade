...
import io.donbee.jade.content.lang.sl.SL0Vocabulary;
import io.donbee.jade.content.lang.sl.SimpleSLTokenizer;
...
import io.donbee.jade.domain.FIPAAgentManagement.MissingParameter;
import io.donbee.jade.domain.FIPAAgentManagement.MultiValueProperty;
 ...
 * executed or a io.donbee.jade.domain.FIPAException exception has been thrown 
 ...
 * non-blocking way. In these cases a <code>io.donbee.jade.proto.AchieveREInitiator</code>
 * or <code>io.donbee.jade.proto.SubscriptionInitiator</code> should be used in 
...
public class DFService extends FIPAService {
	...
	/** 
	 ...
	 the <code>io.donbee.jade.proto.AchieveREInitiator</code> protocol and with
	 ...
	 @see io.donbee.jade.proto.AchieveREInitiator
	...
	/** 
	 ...
	 <p>
	 This method can be fruitfully used in combination with 
	 the <code>io.donbee.jade.proto.SubscriptionInitiator</code> protocol and with
	 ...
	 @see io.donbee.jade.proto.SubscriptionInitiator
	 ...
	 * @return the behaviour to be added to the agent
	 ...
	 @see io.donbee.jade.domain.FIPAAgentManagement.FIPAManagementOntology
