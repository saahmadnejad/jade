...
/** Tests:
 * java io.donbee.jade.Boot (with/without rmiregistry started): run a main-container
 * java io.donbee.jade.Boot -host pippo.cselt.it
 * java io.donbee.jade.Boot -host fbellif.cselt.it
 * java io.donbee.jade.Boot -host fbellif.cselt.it -port 1200
 * java io.donbee.jade.Boot -help
 * java io.donbee.jade.Boot -gui
 **/
package io.donbee.jade;
...
//import io.donbee.jade.core.BootProfileImpl;
import io.donbee.jade.util.ExtendedProperties;
import io.donbee.jade.util.PropertiesException;
//import io.donbee.jade.security.SecurityFactory;
...
public class Boot3 {
    ...
    public Boot3(String[] args) {
        ...
        if (profile.getParameter(Profile.IMTP, null) == null) {
	        profile.setParameter(Profile.IMTP, "io.donbee.jade.imtp.rmi.RMIIMTPManager");
        }
    ...
    public void usage(PrintStream out) {
        out.println("Usage: java io.donbee.jade.Boot [options] [agent specifiers]");
        out.println("");
	...
	out.println("  -nomobility\t\tIf specified, disables the mobility and cloning support for the container.");
        ...
        out.println("  \tjava io.donbee.jade.Boot -container peter:myAgent");
        out.println("");
        out.println("  Connect to a platform on host zork.zot.za, on port 1100,");
        out.println("  starting two agents");
        out.println("  java io.donbee.jade.Boot -container -host zork.zot.za -port 1100 peter:heAgent paula:sheAgent");
        out.println("");
        out.println("  Create an Agent Platform and starts an agent on the local Agent Container");
        out.println("  \tjava io.donbee.jade.Boot Willy:searchAgent");
        out.println("");
        System.exit(0);
    }
