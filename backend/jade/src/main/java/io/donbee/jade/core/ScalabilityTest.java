...
import io.donbee.jade.imtp.leap.JICP.PDPContextManager;
import io.donbee.jade.imtp.leap.JICP.JICPProtocol;

import java.io.*;
import java.util.Random;

// All JADE configuration options must be specified prefixing them with "io.donbee.jade."
// Command line example:
// java -cp .... -io.donbee.jade.port 2099 -io.donbee.jade.proto ssl -i 100 -s 10000 -t 5000 -n 10 -measure rtt
...
public class ScalabilityTest {
	...
	public static void main(String[] args) {
		...
		Properties jadeProps = pp.extractSubset("io.donbee.jade.");
	...
	private static void initCouple(Properties basePP, String prefix, int index) {
		String senderClass = "io.donbee.jade.core.ScalabilityTest$BitrateSenderAgent";
		String receiverClass = "io.donbee.jade.core.ScalabilityTest$BitrateReceiverAgent";
		if (measure == RTT_MEASURE) {
			senderClass = "io.donbee.jade.core.ScalabilityTest$RTTSenderAgent";
			receiverClass = "io.donbee.jade.core.ScalabilityTest$RTTReceiverAgent";
		}
