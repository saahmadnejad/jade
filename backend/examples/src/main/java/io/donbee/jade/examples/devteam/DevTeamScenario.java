...
public class DevTeamScenario implements Scenario {
    ...
    public List<ScenarioParam> params() {
        return List.of(
            ...
            ScenarioParam.stringParam("fallbackModel", "nvidia/nemotron-3.5-lightning:free",
            ...
            ScenarioParam.stringParam("managerModel", "nvidia/nemotron-3.5-lightning:free", "Manager model (reserved)"),
            ScenarioParam.stringParam("architectModel", "nvidia/nemotron-3.5-lightning:free", "Architect model"),
            ScenarioParam.stringParam("implementerModel", "nvidia/nemotron-3.5-lightning:free", "Implementer model"),
            ScenarioParam.stringParam("testerModel", "nvidia/nemotron-3.5-lightning:free", "Tester model"),
            ScenarioParam.stringParam("reviewerModel", "nvidia/nemotron-3.5-lightning:free", "Reviewer model"),
