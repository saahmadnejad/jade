...
public class GenericCommand implements HorizontalCommand, VerticalCommand  {
	...
	/**
	 ...
	 @see io.donbee.jade.core.IMTPManager
	 */
	...
	public io.donbee.jade.security.JADEPrincipal getPrincipal() {
		return principal;
	} // end getPrincipal
	
	public void setPrincipal( io.donbee.jade.security.JADEPrincipal p) {
	...
	public io.donbee.jade.security.Credentials getCredentials() {
		return creds;
	} // end getCredentials
	
	public void setCredentials( io.donbee.jade.security.Credentials creds) {
	...
	private io.donbee.jade.security.JADEPrincipal principal = null;
	private io.donbee.jade.security.Credentials creds;
