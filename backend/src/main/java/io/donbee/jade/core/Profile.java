...
public abstract class Profile {
	...
	//#J2ME_EXCLUDE_BEGIN
	public static final String DEFAULT_SERVICES = "io.donbee.jade.core.mobility.AgentMobilityService;io.donbee.jade.core.event.NotificationService";
	public static final String DEFAULT_SERVICES_NOMOBILITY = "io.donbee.jade.core.event.NotificationService";
	//#J2ME_EXCLUDE_END
	
	// On PJAVA the Notification service is not supported
	//#DOTNET_EXCLUDE_BEGIN
	/*#PJAVA_INCLUDE_BEGIN
	 public static final String DEFAULT_SERVICES = "io.donbee.jade.core.mobility.AgentMobilityService";
