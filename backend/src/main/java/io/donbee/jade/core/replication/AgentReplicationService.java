...
import io.donbee.jade.core.behaviours.OneShotBehaviour;
import io.donbee.jade.core.management.AgentManagementSlice;
import io.donbee.jade.core.messaging.GenericMessage;
import io.donbee.jade.core.messaging.MessagingService;
import io.donbee.jade.core.messaging.MessagingSlice;
import io.donbee.jade.core.mobility.AgentMobilityHelper;
import io.donbee.jade.core.mobility.AgentMobilityService;
import io.donbee.jade.domain.AMSService;
		...
		public final boolean accept(VerticalCommand cmd) {
			...
			if (name.equals(MessagingSlice.SEND_MESSAGE)) {
				...
				if (info != null) {
					...
					// io.donbee.jade.core.messaging.OutBox.addLast())
