...
import io.donbee.jade.util.leap.Serializable;
...
import io.donbee.jade.lang.acl.*;
...
import io.donbee.jade.core.mobility.AgentMobilityHelper;
import io.donbee.jade.core.mobility.Movable;
...
//#APIDOC_EXCLUDE_END
{
	...
	/**
	 ...
	 <code>b</code>.
	 @see io.donbee.jade.core.behaviours.Behaviour#block(long millis)
	 */
	...
	/**
	 ...
	 @see io.donbee.jade.core.behaviours.Behaviour#restart()
	 */
	 ...
	 * of agent migration.
	 */
	private transient io.donbee.jade.wrapper.AgentContainer myContainer = null;
	 ...
	 * <br>
	 * @return AgentContainer a controller for the container this agent lives in.
	 */
	public io.donbee.jade.wrapper.AgentContainer getContainerController() {
		if (myContainer == null) {  // first time called
			try {
				io.donbee.jade.security.JADEPrincipal principal = null;
				io.donbee.jade.security.Credentials credentials = null;
				try {
					io.donbee.jade.security.CredentialsHelper ch = (io.donbee.jade.security.CredentialsHelper) getHelper("io.donbee.jade.core.security.Security");
	...
	/**
	 ...
	 @see io.donbee.jade.core.Agent#getQueueSize()
	 */
	...
	/**
	 ...
	 @see io.donbee.jade.core.Agent#setQueueSize(int newSize)
	 @see io.donbee.jade.core.Agent#getCurQueueSize()
	 */
	...
	/**
	 ...
	 <b>NOT available in MIDP</b>
	 <br>
	 @see io.donbee.jade.core.Agent#doActivate()
	 */
	...
	/**
	 ...
	 <b>NOT available in MIDP</b>
	 <br>
	 @see io.donbee.jade.core.Agent#doSuspend()
	 */
	...
	/**
	 ...
	 @see io.donbee.jade.core.Agent#doWake()
	 */
	public void doWait() {
		doWait(0);
	}
	...
	/**
	 ...
	 @see io.donbee.jade.core.Agent#doWait()
	 */
	 ...
	 * @see io.donbee.jade.core.Agent#restoreFields(InputStream s)
	 */
	...
	/**
	 ...
	 stream reading.
	 @see io.donbee.jade.core.Agent#write(OutputStream s)
	 *
	 ...
	 * The io.donbee.jade.core.Restore annotation can be used to skip the restoration of a field
	...
	/**
	 ...
	 same-named method of <code>Agent</code> instead.
	 <br>
	 <b>NOT available in MIDP</b>
	 <br>
	 @see AgentController#putO2AObject(Object o, boolean blocking)
	 */
	...
	/**
	 ...
	 <code>io.donbee.jade.core.Agent.setEnabledO2ACommunication()</code> method.
	 ...
	 the queue is empty.
	 @see AgentController#putO2AObject(Object o, boolean blocking)
	 @see io.donbee.jade.core.Agent#setEnabledO2ACommunication(boolean enabled, int queueSize)
	 */
	...
	/**
	 ...
	 @see io.donbee.jade.core.Agent#setup()
	 @see io.donbee.jade.core.Agent#takeDown()
	 */
	...
	/**
	 ...
	 able to do anything.
	 @see io.donbee.jade.core.Agent#addBehaviour(Behaviour b)
	 @see io.donbee.jade.core.behaviours.Behaviour
	 */
	...
	/**
	 ...
	 send.
	 @see io.donbee.jade.lang.acl.ACLMessage
	 */
	...
	/**
	 ...
	 @see io.donbee.jade.lang.acl.ACLMessage
	 @see io.donbee.jade.lang.acl.MessageTemplate
	 */
	...
	/**
	 ...
	 available.
	 @see io.donbee.jade.core.Agent#receive()
	 @see io.donbee.jade.lang.acl.ACLMessage
	 */
	...
	/**
	 ...
	 @see io.donbee.jade.core.Agent#receive(MessageTemplate)
	 @see io.donbee.jade.lang.acl.ACLMessage
	 @see io.donbee.jade.lang.acl.MessageTemplate
	 */
	...
	/**
	 ...
	 @see io.donbee.jade.core.Agent#blockingReceive()
	 */
	...
	/**
	 ...
	 @see io.donbee.jade.core.Agent#send(ACLMessage msg)
	 */
