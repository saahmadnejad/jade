...
import io.donbee.jade.core.ServiceFinder;
...
import io.donbee.jade.core.BackEndContainer;
...
import io.donbee.jade.core.UnreachableException;
...
public class BEAgentManagementService extends BaseService {
	...
	static final String NAME = "io.donbee.jade.core.management.AgentManagement";
		...
		private void handleInformCreated(VerticalCommand cmd) throws IMTPException, NotFoundException, NameClashException, JADESecurityException, ServiceException {
			...
			try {
				...
				try {
					...
					mainSlice = (AgentManagementSlice)getFreshSlice(io.donbee.jade.core.ServiceFinder.MAIN_SLICE);
					mainSlice.bornAgent(agentID, cid, cmd);
				}
			}
			catch (IMTPException imtpe) {
