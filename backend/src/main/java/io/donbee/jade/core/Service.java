...
public interface Service {
	...
	public interface Slice extends Serializable {
	   ...
	   @see io.donbee.jade.core.Service#getSlice(String name)
		 */
		Service getService();
	...
	/**
       ...
       supporting routed dispatching of horizontal commands.
			 @deprecated use the class io.donbee.jade.core.SliceProxy instead of this inner class
	 */
	public class SliceProxy extends io.donbee.jade.core.SliceProxy implements Slice {
	...
	/**
       ...
       @see io.donbee.jade.core.Service#getOwnedCommands()
	 */
