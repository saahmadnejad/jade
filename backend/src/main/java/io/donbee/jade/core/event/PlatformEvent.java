...
import io.donbee.jade.wrapper.PlatformController;
 ...
 */
public class PlatformEvent extends JADEEvent implements io.donbee.jade.wrapper.PlatformEvent {
	 ...
	 * an {@link io.donbee.jade.domain.FIPAAgentManagement.InternalError InternalError}
	 ...
	 * @param The {@link io.donbee.jade.core.AID AID} of the new or dead agent.
	 * @param eventSource The container id of the source of the event.
	 ...
	 * <p>
	 * @param The {@link io.donbee.jade.core.AID AID} of the moved agent.
	...
	/**
	 * Returns the {@link io.donbee.jade.core.ContainerID ContainerID} of the event source.
	 * <p>
	 ...
	 * <p>
	 * @return The {@link io.donbee.jade.core.ContainerID ContainerID} of the event source.
	 * @see #getNewContainer()
	 */
	...
	/**
	 * Returns the {@link io.donbee.jade.core.ContainerID ContainerID} of the container
	 ...
	 * <p>
	 * @return The {@link io.donbee.jade.core.ContainerID ContainerID} of the container
	...
	/**
	 * Returns the {@link io.donbee.jade.core.AID AID} of the agent that was born,
	 ...
	 * involved.
	 * <p>
	 * @return The {@link io.donbee.jade.core.AID AID} of the agent that was born,
	 * died, or moved.
	 * @see #getContainer()
	 */
	public AID getAgent() {
	...
	public void setSource(Object s) {
		source = s;
		if (source instanceof PlatformController) {
			myPlatformName = ((PlatformController) source).getName();
		}
	}
