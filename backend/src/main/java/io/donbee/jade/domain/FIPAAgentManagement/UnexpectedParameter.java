...
package io.donbee.jade.domain.FIPAAgentManagement;
...
public class UnexpectedParameter extends RefuseException implements Predicate {
  ...
  public UnexpectedParameter(String objectName, String parameterName) {
    super("(unexpected-parameter "+objectName+" "+parameterName+")");
    s1=objectName;
    s2=parameterName;
  }
