...
import io.donbee.jade.domain.introspection.*;
import io.donbee.jade.domain.mobility.*;
...
/**
 ...
 @version $Date: 2018-11-07 16:35:22 +0100 (mer, 07 nov 2018) $ $Revision: 6840 $
 */
public class ams extends Agent /*implements AgentManager.Listener*/ {
	...
	protected void setup() {		
		...
		// Use fully qualified name to avoid conflict with old io.donbee.jade.domain.MobilityOntology
		getContentManager().registerOntology(io.donbee.jade.domain.mobility.MobilityOntology.getInstance());
		...
		MessageTemplate mtJ = MessageTemplate.and(MessageTemplate.MatchPerformative(ACLMessage.REQUEST), MessageTemplate.or(MessageTemplate.MatchOntology(JADEManagementVocabulary.NAME), MessageTemplate.MatchOntology(io.donbee.jade.domain.mobility.MobilityOntology.NAME)));
