			...
			if(reply != null) {
				if (reply.getPerformative() == ACLMessage.INFORM){
					...
					case ACLMessage.REFUSE:
						throw new io.donbee.jade.domain.FIPAAgentManagement.RefuseException(reply);
					case ACLMessage.FAILURE:
						throw new io.donbee.jade.domain.FIPAAgentManagement.FailureException(reply);
					case ACLMessage.NOT_UNDERSTOOD:
						throw new io.donbee.jade.domain.FIPAAgentManagement.NotUnderstoodException(reply);
					}
					//#MIDP_EXCLIDE_END
