...
public class MicroBoot {
	...
	private static Logger logger = Logger.getMyLogger("io.donbee.jade.MicroBoot");
	...
	private static void printUsage() {
		...
		logger.log(Logger.ALL,"java -cp <classpath> io.donbee.jade.MicroBoot [options] [agents]");
