...
* @see io.donbee.jade.gui.VisualStringList
* @see io.donbee.jade.gui.ServiceDscDlg
* @see io.donbee.jade.domain.FIPAAgentManagement.ServiceDescription
...
public class VisualServicesList extends VisualStringList
{
  ...
  */
  boolean checkSlots;
	...
	VisualServicesList(io.donbee.jade.util.leap.Iterator content, Component owner)
	{
		super(content,owner);
		checkSlots = true;
	}
