...
/**
   ...
   Use <code>io.donbee.jade.wrapper.ContainerController</code> instead.

   @author Giovanni Caire - TILAB
 */
public class AgentContainer extends ContainerController implements PlatformController {

	public AgentContainer(ContainerProxy cp, io.donbee.jade.core.AgentContainer impl, String platformName) {
