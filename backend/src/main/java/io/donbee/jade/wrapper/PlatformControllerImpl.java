...
class PlatformControllerImpl implements PlatformController {
	...
	PlatformControllerImpl(ContainerController c, AgentManager m) {
		...
		myMain.addListener(new AgentManagerListenerAdapter() {
			public void removedContainer(io.donbee.jade.core.event.PlatformEvent ev) {
	...
	/**
	 ...
	 all the methods of the io.donbee.jade.core.AgentManager.Listener interface
	 */
	class AgentManagerListenerAdapter implements AgentManager.Listener {
		
		public void addedContainer(io.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void removedContainer(io.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void bornAgent(io.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void deadAgent(io.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void movedAgent(io.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void suspendedAgent(io.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void resumedAgent(io.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void frozenAgent(io.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void thawedAgent(io.donbee.jade.core.event.PlatformEvent ev) {
		}
		
		public void addedMTP(io.donbee.jade.core.event.MTPEvent ev) {
		}
		public void removedMTP(io.donbee.jade.core.event.MTPEvent ev) {
		}
		public void messageIn(io.donbee.jade.core.event.MTPEvent ev) {
		}
		public void messageOut(io.donbee.jade.core.event.MTPEvent ev) {
		}
	} // END of inner class AgentManagerListenerAdapter	  
	
	/**
	 Inner class ListenerWrapper
	 This utility class wraps a io.donbee.jade.wrapper.PlatformController.Listener
	 into a io.donbee.jade.core.AgentManager.Listener
	 */
		...
		public void removedContainer(io.donbee.jade.core.event.PlatformEvent ev) {
			...
			try {
				if (cid.getName().equals(myContainer.getContainerName())) {
					// The local main container is terminating -->
					// The whole platform is terminating
					myListener.killedPlatform(new io.donbee.jade.wrapper.PlatformEvent() {
