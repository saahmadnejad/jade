...
package io.donbee.jade.wrapper;
...
/**
   ...
   <br>
   @see io.donbee.jade.wrapper.AgentContainer#createNewAgent(String, String, Object[])
...
class AgentControllerImpl implements AgentController {
	...
	private io.donbee.jade.core.AgentContainer myContainer;
	...
	/**
     ...
     be used instead.
	 */
	public AgentControllerImpl(AID id, ContainerProxy cp, io.donbee.jade.core.AgentContainer ac) {
		agentID = id;
		myProxy = cp;
		myContainer = ac;
	}
	...
	/**
	 * @see io.donbee.jade.wrapper.AgentController#getName()
	 */
	public String getName() throws StaleProxyException {
		// Just to check that the agent is still there
		io.donbee.jade.core.Agent a = myContainer.acquireLocalAgent(agentID);
		if (a == null) {
	...
	/**
	 * @see io.donbee.jade.wrapper.AgentController#start()
	 */
	...
	/**
	 * @see io.donbee.jade.wrapper.AgentController#suspend()
	 */
	...
	/**
	 * @see io.donbee.jade.wrapper.AgentController#activate()
	 */
	...
	/**
	 * @see io.donbee.jade.wrapper.AgentController#kill()
	 */
	...
	/**
	 * @see io.donbee.jade.wrapper.AgentController#move(io.donbee.jade.core.Location)
	 */
	...
	/**
	 * @see io.donbee.jade.wrapper.AgentController#clone(io.donbee.jade.core.Location, java.lang.String)
	 */
	...
	/**
	 * @see io.donbee.jade.wrapper.AgentController#putO2AObject(java.lang.Object, boolean)
	 */
	public void putO2AObject(Object o, boolean blocking) throws StaleProxyException {
		io.donbee.jade.core.Agent adaptee = myContainer.acquireLocalAgent(agentID);
		if (adaptee == null) {
	...
	/**
	 * @see io.donbee.jade.wrapper.AgentController#getState()
	 */
	public State getState() throws StaleProxyException {
		...
		State ret = null;
		switch (jadeState) {
		case io.donbee.jade.core.Agent.AP_INITIATED:
			ret =  AgentState.AGENT_STATE_INITIATED;
			break;
		case io.donbee.jade.core.Agent.AP_ACTIVE:
			ret =  AgentState.AGENT_STATE_ACTIVE;
			break;
		case io.donbee.jade.core.Agent.AP_IDLE:
			ret =  AgentState.AGENT_STATE_IDLE;
			break;
		case io.donbee.jade.core.Agent.AP_SUSPENDED:
			ret =  AgentState.AGENT_STATE_SUSPENDED;
			break;
		case io.donbee.jade.core.Agent.AP_WAITING:
			ret =  AgentState.AGENT_STATE_WAITING;
			break;
		case io.donbee.jade.core.Agent.AP_DELETED:
			ret =  AgentState.AGENT_STATE_DELETED;
			break;
			// FIXME: Correctly handle states defined outside the Agent class
			/*case io.donbee.jade.core.Agent.AP_TRANSIT:
