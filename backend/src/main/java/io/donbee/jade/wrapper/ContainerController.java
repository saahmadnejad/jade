...
/**
   ...
   <br>
   @see io.donbee.jade.core.Runtime#createAgentContainer(Profile)
...
public class ContainerController {
	...
	public AgentController getAgent(String name, boolean isGuid) throws ControllerException {
		...
		io.donbee.jade.core.Agent instance = myImpl.acquireLocalAgent(agentID);
		if (instance == null) {
	 ...
	 */
	public AgentController acceptNewAgent(String nickname, io.donbee.jade.core.Agent anAgent) throws StaleProxyException {
		if (myImpl == null || myProxy == null) {
			throw new StaleProxyException();
		}
		...
		try {
			io.donbee.jade.core.NodeDescriptor nd = myImpl.getNodeDescriptor();
