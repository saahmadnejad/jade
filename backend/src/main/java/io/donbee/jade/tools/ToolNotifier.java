...
import io.donbee.jade.core.event.MessageEvent;
import io.donbee.jade.core.event.MessageListener;
import io.donbee.jade.core.event.AgentEvent;
import io.donbee.jade.core.event.AgentListener;
import io.donbee.jade.core.event.NotificationHelper;
import io.donbee.jade.core.event.NotificationService;
	...
	public void sentMessage(MessageEvent ev) {
		if (state == ACTIVE_STATE) {
			...
			if(observedAgents.contains(sender)) {
				...
				io.donbee.jade.domain.introspection.ACLMessage m = new io.donbee.jade.domain.introspection.ACLMessage();
