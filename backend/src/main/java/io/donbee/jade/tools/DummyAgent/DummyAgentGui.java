...
class DummyAgentGui extends JFrame 
{
  ...
  // Constructor
    ...
    JMenu currentMsgMenu = new JMenu ("Current message");
	    ...
	    m.setEnvelope(new io.donbee.jade.domain.FIPAAgentManagement.Envelope());	
	  ...
	  public void actionPerformed(ActionEvent e)
	  {
	  	int i = queuedMsgList.getSelectedIndex();
			if (i != -1)
			{
				...
				reply.setEnvelope(new io.donbee.jade.domain.FIPAAgentManagement.Envelope());
