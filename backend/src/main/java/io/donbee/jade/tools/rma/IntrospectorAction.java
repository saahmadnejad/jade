 ...
 * @see io.donbee.jade.gui.AMSAbstractAction
 ...
 */
  ...
  public IntrospectorAction(rma anRMA,ActionProcessor actPro) {
   ...
   public void doAction(AgentTree.ContainerNode node) {
      ...
      myRMA.newAgent("Introspector"+progressiveNumber, "io.donbee.jade.tools.introspector.Introspector", new Object[0], containerName);
      progressiveNumber++;
     }
