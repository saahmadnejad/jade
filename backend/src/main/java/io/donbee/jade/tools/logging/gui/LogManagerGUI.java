package io.donbee.jade.tools.logging.gui;
...
import io.donbee.jade.gui.AgentTree;
import io.donbee.jade.tools.logging.LogManager;
import io.donbee.jade.tools.logging.JavaLoggingLogManagerImpl;
import io.donbee.jade.domain.FIPAException;
import io.donbee.jade.domain.FIPANames;
import io.donbee.jade.domain.FIPAService;
import io.donbee.jade.domain.JADEAgentManagement.CreateAgent;
import io.donbee.jade.domain.JADEAgentManagement.KillAgent;
import io.donbee.jade.domain.JADEAgentManagement.JADEManagementOntology;
import io.donbee.jade.gui.AclGui;
...
public class LogManagerGUI extends JFrame {
	private static final String DEFAULT_LOG_MANAGER_CLASS = "io.donbee.jade.tools.logging.JavaLoggingLogManagerImpl";
	...
	private AID createController(String containerName) throws FIPAException {
		...
		ca.setClassName("io.donbee.jade.tools.logging.LogHelperAgent");
