 ...
 * @see  io.donbee.jade.tools.sniffer.ClearCanvasAction
 * @see  io.donbee.jade.tools.sniffer.ExitAction 
 * @see  io.donbee.jade.tools.sniffer.WriteLogFileAction 
 * @see  io.donbee.jade.tools.sniffer.DisplayLogFileAction
 * @see  io.donbee.jade.tools.sniffer.WriteMessageListAction
 * @see  io.donbee.jade.tools.sniffer.DoSnifferAction
 * @see  io.donbee.jade.tools.sniffer.DoNotSnifferAction
 * @see io.donbee.jade.tools.sniffer.ShowOnlyAction
 */
