...
import io.donbee.jade.domain.persistence.*;
import io.donbee.jade.domain.mobility.*;
import io.donbee.jade.domain.FIPANames;
import io.donbee.jade.gui.AgentTreeModel;
...
import io.donbee.jade.proto.SimpleAchieveREInitiator;

import io.donbee.jade.tools.ToolAgent;
...
public class rma extends ToolAgent {
	...
	public void newAgent(String agentName, String className, Object arg[], String ownerName, String containerName) {
		...
		io.donbee.jade.security.JADEPrincipal intendedOwner = null;
		io.donbee.jade.security.Credentials initialCredentials = null;
		
		if ((ownerName==null) || (ownerName.trim().length()==0)) {
			// it is requested the creation of an agent 
			// with the same owner of the RMA
			try {
				io.donbee.jade.security.JADEPrincipal rmaOwner = null;
				io.donbee.jade.security.Credentials rmaCredentials = null;
			...
			try
			{
				Class c = Class.forName("io.donbee.jade.security.impl.JADEPrincipalImpl");
