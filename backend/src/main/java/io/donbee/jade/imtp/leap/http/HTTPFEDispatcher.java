...
package io.donbee.jade.imtp.leap.http;
...
import io.donbee.jade.imtp.leap.JICP.*;
...
public class HTTPFEDispatcher implements FEConnectionManager, Dispatcher, TimerListener {
	...
	protected String myMediatorClass = "io.donbee.jade.imtp.leap.http.HTTPBEDispatcher";
