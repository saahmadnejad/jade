...
package io.donbee.jade.imtp.leap;
...
//#J2ME_EXCLUDE_BEGIN
import io.donbee.jade.core.messaging.MultipleGenericMessage;
//#J2ME_EXCLUDE_END
...
import io.donbee.jade.imtp.leap.JICP.JICPAddress;
import io.donbee.jade.imtp.leap.http.HTTPAddress;
...
class DeliverableDataOutputStream extends DataOutputStream {
	...
	//#J2ME_EXCLUDE_BEGIN
	private void serializeMultipleGenericMessage(MultipleGenericMessage mgm) throws IOException, LEAPSerializationException {
		java.util.List<GenericMessage> messages = mgm.getMessages();
		writeInt(messages.size());
		for (GenericMessage g : messages) {
			serializeAID(g.getSender());
			serializeGenericMessage(g);
		}
	}
	//#J2ME_EXCLUDE_END
	...
	private Serializer getSerializer(Object o) 
		...
		String serName = new String("io.donbee.jade.imtp.leap."+name+"Serializer");
