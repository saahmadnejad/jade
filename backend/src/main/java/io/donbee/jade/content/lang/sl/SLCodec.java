...
import io.donbee.jade.content.lang.StringCodec;
//#MIDP_EXCLUDE_BEGIN
...
public class SLCodec extends StringCodec {
	...
	private void initParser() {
		int	slType	= io.donbee.jade.domain.FIPANames.ContentLanguage.FIPA_SL0.equals(getName()) ? 0
				: io.donbee.jade.domain.FIPANames.ContentLanguage.FIPA_SL2.equals(getName()) ? 1
						: io.donbee.jade.domain.FIPANames.ContentLanguage.FIPA_SL2.equals(getName()) ? 2 : 3;
