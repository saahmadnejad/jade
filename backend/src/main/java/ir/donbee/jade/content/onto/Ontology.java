...
import ir.donbee.jade.content.abs.AbsAggregate;
import ir.donbee.jade.content.abs.AbsHelper;
import ir.donbee.jade.content.abs.AbsObject;
import ir.donbee.jade.content.schema.AggregateSchema;
import ir.donbee.jade.content.schema.ConceptSlotFunctionSchema;
import ir.donbee.jade.content.schema.ObjectSchema;
import ir.donbee.jade.content.schema.AgentActionSchema;
import ir.donbee.jade.content.schema.ConceptSchema;
import ir.donbee.jade.content.schema.PredicateSchema;
...
import ir.donbee.jade.content.schema.Facet;
import ir.donbee.jade.content.schema.facets.CardinalityFacet;
import ir.donbee.jade.content.schema.facets.DefaultValueFacet;
import ir.donbee.jade.content.schema.facets.PermittedValuesFacet;
import ir.donbee.jade.content.schema.facets.RegexFacet;
//#J2ME_EXCLUDE_END
 ...
 * @see ir.donbee.jade.content.Concept
 * @see ir.donbee.jade.content.abs.AbsConcept
 * @see ir.donbee.jade.content.schema.ConceptSchema
 * @see ir.donbee.jade.content.onto.BasicOntology
 * @author Federico Bergenti - Universita` di Parma
 * @author Giovanni Caire - TILAB
 */
public class Ontology implements Serializable {
	private static final String DEFAULT_INTROSPECTOR_CLASS = "ir.donbee.jade.content.onto.ReflectiveIntrospector";
	...
	static {
		try {
			absObjectClass = Class.forName("ir.donbee.jade.content.abs.AbsObject");
		}
		catch (Exception e) {
			// Should never happen
			e.printStackTrace();
