...
import ir.donbee.jade.content.onto.BasicOntology;
import ir.donbee.jade.content.lang.StringCodec;
import ir.donbee.jade.content.lang.sl.SLVocabulary;
...
public class SimpleSLCodec extends StringCodec {
	...
	public SimpleSLCodec() {
		super(ir.donbee.jade.domain.FIPANames.ContentLanguage.FIPA_SL);
	}
