...
package ir.donbee.jade.imtp.leap;
...
//#J2ME_EXCLUDE_BEGIN
import ir.donbee.jade.core.messaging.MultipleGenericMessage;
//#J2ME_EXCLUDE_END
...
import ir.donbee.jade.imtp.leap.JICP.JICPAddress;
import ir.donbee.jade.imtp.leap.http.HTTPAddress;
...
class DeliverableDataOutputStream extends DataOutputStream {
	...
	private Serializer getSerializer(Object o) 
		...
		String serName = new String("ir.donbee.jade.imtp.leap."+name+"Serializer");
