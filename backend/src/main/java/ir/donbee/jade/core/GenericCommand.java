...
public class GenericCommand implements HorizontalCommand, VerticalCommand  {
	...
	/**
	 ...
	 @see ir.donbee.jade.core.IMTPManager
	 */
	...
	public ir.donbee.jade.security.JADEPrincipal getPrincipal() {
		return principal;
	} // end getPrincipal
	
	public void setPrincipal( ir.donbee.jade.security.JADEPrincipal p) {
	...
	public ir.donbee.jade.security.Credentials getCredentials() {
		return creds;
	} // end getCredentials
	
	public void setCredentials( ir.donbee.jade.security.Credentials creds) {
	...
	private ir.donbee.jade.security.JADEPrincipal principal = null;
	private ir.donbee.jade.security.Credentials creds;
