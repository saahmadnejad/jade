...
/**
   ...
   @see ir.donbee.jade.core.Service
...
public class ServiceDescriptor implements Serializable {
	...
	/**
       ...
       @see ir.donbee.jade.core.ServiceDescriptor#setName(String sn)
       @see ir.donbee.jade.core.ServiceDescriptor#setService(Service svc)
	 */
