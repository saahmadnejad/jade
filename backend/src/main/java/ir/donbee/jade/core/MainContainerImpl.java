...
import ir.donbee.jade.util.leap.Map;
import ir.donbee.jade.util.leap.HashMap;

import ir.donbee.jade.core.behaviours.Behaviour;

import ir.donbee.jade.core.event.PlatformEvent;
import ir.donbee.jade.core.event.MTPEvent;

import ir.donbee.jade.domain.AMSEventQueueFeeder;
import ir.donbee.jade.domain.FIPANames;
import ir.donbee.jade.domain.ams;
import ir.donbee.jade.domain.df;
...
public class MainContainerImpl implements MainContainer, AgentManager {
	 ...
	 * Such class must extend the ir.donbee.jade.domain.df standard class.
	 */
	...
	public void addTool(AID tool) {
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.management.AgentManagementSlice.ADD_TOOL, ir.donbee.jade.core.management.AgentManagementSlice.NAME, null);
		cmd.addParam(tool);
	...
	public void removeTool(AID tool) {
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.management.AgentManagementSlice.REMOVE_TOOL, ir.donbee.jade.core.management.AgentManagementSlice.NAME, null);
		cmd.addParam(tool);
	...
	public void create(String name, String className, Object args[], ContainerID cid, JADEPrincipal owner, Credentials initialCredentials, JADEPrincipal requesterPrincipal, Credentials requesterCredentials) throws UnreachableException, JADESecurityException, NotFoundException, NameClashException {
		...
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.management.AgentManagementSlice.REQUEST_CREATE, ir.donbee.jade.core.management.AgentManagementSlice.NAME, null);
	...
	public void kill(AID agentID, JADEPrincipal requesterPrincipal, Credentials requesterCredentials) throws NotFoundException, UnreachableException, JADESecurityException {
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.management.AgentManagementSlice.REQUEST_KILL, ir.donbee.jade.core.management.AgentManagementSlice.NAME, null);
	...
	public void suspend(final AID agentID) throws NotFoundException, UnreachableException, JADESecurityException {
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.management.AgentManagementSlice.REQUEST_STATE_CHANGE, ir.donbee.jade.core.management.AgentManagementSlice.NAME, null);
		cmd.addParam(agentID);
	...
	public void move(AID agentID, Location where) throws NotFoundException, UnreachableException, JADESecurityException {
		...
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.mobility.AgentMobilityHelper.REQUEST_MOVE, ir.donbee.jade.core.mobility.AgentMobilitySlice.NAME, null);
		cmd.addParam(agentID);
		cmd.addParam(where);
	...
	public void copy(AID agentID, Location where, String newName) throws NotFoundException, NameClashException, UnreachableException, JADESecurityException {
		...
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.mobility.AgentMobilityHelper.REQUEST_CLONE, ir.donbee.jade.core.mobility.AgentMobilitySlice.NAME, null);
		cmd.addParam(agentID);
		cmd.addParam(where);
	...
	public void killContainer(ContainerID cid, JADEPrincipal requesterPrincipal, Credentials requesterCredentials) throws NotFoundException, UnreachableException, JADESecurityException {
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.management.AgentManagementSlice.KILL_CONTAINER, ir.donbee.jade.core.management.AgentManagementSlice.NAME, null);
		cmd.addParam(cid);
		cmd.setPrincipal(requesterPrincipal);
		cmd.setCredentials(requesterCredentials);
	...
	public void shutdownPlatform(JADEPrincipal requesterPrincipal, Credentials requesterCredentials) throws JADESecurityException {	
		...
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.management.AgentManagementSlice.SHUTDOWN_PLATFORM, ir.donbee.jade.core.management.AgentManagementSlice.NAME, null);
		cmd.setPrincipal(requesterPrincipal);
		cmd.setCredentials(requesterCredentials);
		Object ret = myCommandProcessor.processOutgoing(cmd);
		if (ret != null) {
	...
	public MTPDescriptor installMTP(String address, ContainerID cid, String className) throws NotFoundException, UnreachableException, MTPException {
		...
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.messaging.MessagingSlice.INSTALL_MTP, ir.donbee.jade.core.messaging.MessagingSlice.NAME, null);
	...
	public void uninstallMTP(String address, ContainerID cid) throws NotFoundException, UnreachableException, MTPException {
		...
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.messaging.MessagingSlice.UNINSTALL_MTP, ir.donbee.jade.core.messaging.MessagingSlice.NAME, null);
		cmd.addParam(address);
		cmd.addParam(cid);
	...
	public void sniffOn(AID snifferName, List toBeSniffed) throws NotFoundException, UnreachableException  {
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.event.NotificationSlice.SNIFF_ON, ir.donbee.jade.core.event.NotificationSlice.NAME, null);
	...
	public void sniffOff(AID snifferName, List notToBeSniffed) throws NotFoundException, UnreachableException {
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.event.NotificationSlice.SNIFF_OFF, ir.donbee.jade.core.event.NotificationSlice.NAME, null);
		cmd.addParam(snifferName);
	...
	public void debugOn(AID debuggerName, List toBeDebugged) throws NotFoundException, UnreachableException {
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.event.NotificationSlice.DEBUG_ON, ir.donbee.jade.core.event.NotificationSlice.NAME, null);
	...
	public void debugOff(AID debuggerName, List notToBeDebugged) throws NotFoundException, UnreachableException {
		GenericCommand cmd = new GenericCommand(ir.donbee.jade.core.event.NotificationSlice.DEBUG_OFF, ir.donbee.jade.core.event.NotificationSlice.NAME, null);
		cmd.addParam(debuggerName);
	...
	private void removeAllMTPs(ContainerID cid) {
		try {
			...
			for(int i = 0; i < objs.length; i++) {
				...
				GenericCommand gCmd = new GenericCommand(ir.donbee.jade.core.messaging.MessagingSlice.DEAD_MTP, ir.donbee.jade.core.messaging.MessagingSlice.NAME, null);
				gCmd.addParam(mtp);
				gCmd.addParam(cid);
