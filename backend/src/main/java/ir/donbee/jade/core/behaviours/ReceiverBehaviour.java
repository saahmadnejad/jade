...
/**
   ...
   @see ir.donbee.jade.core.behaviours.SenderBehaviour
...
public final class ReceiverBehaviour extends Behaviour {
  ...
  /**
   ...
   timeout.
   @see ir.donbee.jade.core.behaviours.ReceiverBehaviour.Handle#getMessage()
  */
  ...
  */
  ...
  /**
   ...
   exception.
   @see ir.donbee.jade.core.behaviours.ReceiverBehaviour#newHandle()
   @see ir.donbee.jade.core.behaviours.ReceiverBehaviour#ReceiverBehaviour(Agent
  ...
  /**
   ...
   @see ir.donbee.jade.core.behaviours.ReceiverBehaviour.Handle
  */
  ...
  */
  ...
  /**
     ...
     @param mt A Message template to match incoming messages against, null to
     indicate no template and receive any message that arrives.
     @see ir.donbee.jade.core.behaviours.ReceiverBehaviour#ReceiverBehaviour(Agent a, Handle h, long millis)
  */
