...
class PersistentDeliveryManager {
	...
	private static final String DEFAULT_STORAGE = "ir.donbee.jade.core.messaging.PersistentDeliveryManager$DummyStorage";
	private static final String FILE_STORAGE = "ir.donbee.jade.core.messaging.FileMessageStorage";
