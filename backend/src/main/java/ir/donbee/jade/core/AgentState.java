...
public class AgentState {
    ...
    */
	...
	//#MIDP_EXCLUDE_BEGIN
	new AgentState("Transit", ir.donbee.jade.core.mobility.AgentMobilityService.AP_TRANSIT),
	new AgentState("Copy", ir.donbee.jade.core.mobility.AgentMobilityService.AP_COPY),
	new AgentState("Gone", ir.donbee.jade.core.mobility.AgentMobilityService.AP_GONE),
