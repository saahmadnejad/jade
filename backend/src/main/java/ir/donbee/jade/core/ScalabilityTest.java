...
import ir.donbee.jade.imtp.leap.JICP.PDPContextManager;
import ir.donbee.jade.imtp.leap.JICP.JICPProtocol;

import java.io.*;
import java.util.Random;

// All JADE configuration options must be specified prefixing them with "ir.donbee.jade."
// Command line example:
// java -cp .... -ir.donbee.jade.port 2099 -ir.donbee.jade.proto ssl -i 100 -s 10000 -t 5000 -n 10 -measure rtt
...
public class ScalabilityTest {
	...
	public static void main(String[] args) {
		...
		Properties jadeProps = pp.extractSubset("ir.donbee.jade.");
	...
	private static void initCouple(Properties basePP, String prefix, int index) {
		String senderClass = "ir.donbee.jade.core.ScalabilityTest$BitrateSenderAgent";
		String receiverClass = "ir.donbee.jade.core.ScalabilityTest$BitrateReceiverAgent";
		if (measure == RTT_MEASURE) {
			senderClass = "ir.donbee.jade.core.ScalabilityTest$RTTSenderAgent";
			receiverClass = "ir.donbee.jade.core.ScalabilityTest$RTTReceiverAgent";
		}
