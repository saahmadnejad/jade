...
import ir.donbee.jade.util.leap.Serializable;
...
import ir.donbee.jade.core.mobility.AgentMobilityHelper;
import ir.donbee.jade.core.mobility.Movable;
...
//#APIDOC_EXCLUDE_END
{
	...
	/**
	 ...
	 <code>b</code>.
	 @see ir.donbee.jade.core.behaviours.Behaviour#block(long millis)
	 */
	...
	/**
	 ...
	 @see ir.donbee.jade.core.behaviours.Behaviour#restart()
	 */
	 ...
	 * of agent migration.
	 */
	private transient ir.donbee.jade.wrapper.AgentContainer myContainer = null;
	 ...
	 */
	public ir.donbee.jade.wrapper.AgentContainer getContainerController() {
		if (myContainer == null) {  // first time called
			try {
				ir.donbee.jade.security.JADEPrincipal principal = null;
				ir.donbee.jade.security.Credentials credentials = null;
				try {
					ir.donbee.jade.security.CredentialsHelper ch = (ir.donbee.jade.security.CredentialsHelper) getHelper("ir.donbee.jade.core.security.Security");
	...
	/**
	 ...
	 @see ir.donbee.jade.core.Agent#getQueueSize()
	 */
	...
	/**
	 ...
	 @see ir.donbee.jade.core.Agent#setQueueSize(int newSize)
	 @see ir.donbee.jade.core.Agent#getCurQueueSize()
	 */
	...
	/**
	 ...
	 <b>NOT available in MIDP</b>
	 <br>
	 @see ir.donbee.jade.core.Agent#doActivate()
	 */
	...
	/**
	 ...
	 <b>NOT available in MIDP</b>
	 <br>
	 @see ir.donbee.jade.core.Agent#doSuspend()
	 */
	...
	/**
	 ...
	 @see ir.donbee.jade.core.Agent#doWake()
	 */
	public void doWait() {
		doWait(0);
	}
	...
	/**
	 ...
	 @see ir.donbee.jade.core.Agent#doWait()
	 */
	 ...
	 * @see ir.donbee.jade.core.Agent#restoreFields(InputStream s)
	 */
	...
	/**
	 ...
	 stream reading.
	 @see ir.donbee.jade.core.Agent#write(OutputStream s)
	 *
	 ...
	 * The ir.donbee.jade.core.Restore annotation can be used to skip the restoration of a field
	...
	/**
	 ...
	 <code>ir.donbee.jade.core.Agent.setEnabledO2ACommunication()</code> method.
	 ...
	 the queue is empty.
	 @see AgentController#putO2AObject(Object o, boolean blocking)
	 @see ir.donbee.jade.core.Agent#setEnabledO2ACommunication(boolean enabled, int queueSize)
	 */
	...
	/**
	 ...
	 @see ir.donbee.jade.core.Agent#setup()
	 @see ir.donbee.jade.core.Agent#takeDown()
	 */
	...
	/**
	 ...
	 able to do anything.
	 @see ir.donbee.jade.core.Agent#addBehaviour(Behaviour b)
	 @see ir.donbee.jade.core.behaviours.Behaviour
	 */
	...
	/**
	 ...
	 send.
	 @see ir.donbee.jade.lang.acl.ACLMessage
	 */
	...
	/**
	 ...
	 @see ir.donbee.jade.lang.acl.ACLMessage
	 @see ir.donbee.jade.lang.acl.MessageTemplate
	 */
	...
	/**
	 ...
	 available.
	 @see ir.donbee.jade.core.Agent#receive()
	 @see ir.donbee.jade.lang.acl.ACLMessage
	 */
	...
	/**
	 ...
	 @see ir.donbee.jade.core.Agent#receive(MessageTemplate)
	 @see ir.donbee.jade.lang.acl.ACLMessage
	 @see ir.donbee.jade.lang.acl.MessageTemplate
	 */
	...
	/**
	 ...
	 @see ir.donbee.jade.core.Agent#blockingReceive()
	 */
	...
	/**
	 ...
	 @see ir.donbee.jade.core.Agent#send(ACLMessage msg)
	 */
