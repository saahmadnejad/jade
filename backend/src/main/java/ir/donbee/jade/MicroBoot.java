...
public class MicroBoot {
	...
	private static Logger logger = Logger.getMyLogger("ir.donbee.jade.MicroBoot");
	...
	private static void printUsage() {
		...
		logger.log(Logger.ALL,"java -cp <classpath> ir.donbee.jade.MicroBoot [options] [agents]");
