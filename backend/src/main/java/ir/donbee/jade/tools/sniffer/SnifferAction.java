 ...
 * @see  ir.donbee.jade.tools.sniffer.ClearCanvasAction
 * @see  ir.donbee.jade.tools.sniffer.ExitAction 
 * @see  ir.donbee.jade.tools.sniffer.WriteLogFileAction 
 * @see  ir.donbee.jade.tools.sniffer.DisplayLogFileAction
 * @see  ir.donbee.jade.tools.sniffer.WriteMessageListAction
 * @see  ir.donbee.jade.tools.sniffer.DoSnifferAction
 * @see  ir.donbee.jade.tools.sniffer.DoNotSnifferAction
 * @see ir.donbee.jade.tools.sniffer.ShowOnlyAction
 */
