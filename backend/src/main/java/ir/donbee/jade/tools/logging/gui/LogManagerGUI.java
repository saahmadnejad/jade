package ir.donbee.jade.tools.logging.gui;
...
import ir.donbee.jade.gui.AgentTree;
import ir.donbee.jade.tools.logging.LogManager;
import ir.donbee.jade.tools.logging.JavaLoggingLogManagerImpl;
import ir.donbee.jade.domain.FIPAException;
import ir.donbee.jade.domain.FIPANames;
import ir.donbee.jade.domain.FIPAService;
import ir.donbee.jade.domain.JADEAgentManagement.CreateAgent;
import ir.donbee.jade.domain.JADEAgentManagement.KillAgent;
import ir.donbee.jade.domain.JADEAgentManagement.JADEManagementOntology;
import ir.donbee.jade.gui.AclGui;
...
public class LogManagerGUI extends JFrame {
	private static final String DEFAULT_LOG_MANAGER_CLASS = "ir.donbee.jade.tools.logging.JavaLoggingLogManagerImpl";
	...
	private AID createController(String containerName) throws FIPAException {
		...
		ca.setClassName("ir.donbee.jade.tools.logging.LogHelperAgent");
