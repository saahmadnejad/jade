...
package ir.donbee.jade.tools.introspector.gui;
...
import ir.donbee.jade.domain.introspection.SentMessage;
import ir.donbee.jade.domain.introspection.PostedMessage;
import ir.donbee.jade.domain.introspection.ReceivedMessage;
...
public class TableUpdater implements Runnable {
  ...
  public TableUpdater(MessagePanel wnd, SentMessage sm) {
    try {
      ...
      String charset; 
      Envelope e;
      ir.donbee.jade.domain.introspection.ACLMessage m = sm.getMessage();
  ...
  public TableUpdater(MessagePanel wnd, PostedMessage pm) {
    try {
      ...
      String charset; 
      Envelope e;
      ir.donbee.jade.domain.introspection.ACLMessage m = pm.getMessage();
      if (((e = m.getEnvelope()) == null) ||
          ((charset = e.getPayloadEncoding()) == null)) {
        charset = ACLCodec.DEFAULT_CHARSET;
      }
  ...
  public TableUpdater(MessagePanel wnd, ReceivedMessage rm) {
    try {
      ...
      String charset; 
      Envelope e;
      ir.donbee.jade.domain.introspection.ACLMessage m = rm.getMessage();
      if (((e = m.getEnvelope()) == null) ||
          ((charset = e.getPayloadEncoding()) == null)) {
        charset = ACLCodec.DEFAULT_CHARSET;
      }
