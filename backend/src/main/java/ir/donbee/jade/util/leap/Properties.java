 ...
 * **************************************************************
 */
package ir.donbee.jade.util.leap;
...
#MIDP_INCLUDE_END*/
  ...
  */
  ...
  public String getProperty(String key) {
    ...
    if (prop == null && fromJad && ir.donbee.jade.core.Agent.midlet != null) {
      prop = ir.donbee.jade.core.Agent.midlet.getAppProperty(JAD_PREFIX + key);
	    // in MIDP2.0, names of user-def properties cannot start with MIDlet
			// for backward compatibility with JADE 3.3 we try both names
      if (prop == null)
        prop = ir.donbee.jade.core.Agent.midlet.getAppProperty(JAD_PREFIX_old + key);
    } 
    return prop;
  } 
