 ...
 * <code>java -Djava.util.logging.config.file=mylogging.properties ir.donbee.jade.Boot ...</code>
 *
 ...
 * by means of the <code>ir.donbee.jade.util.leap.OutputViewer</code> MIDlet included
