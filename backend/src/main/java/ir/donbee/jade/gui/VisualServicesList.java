...
* @see ir.donbee.jade.gui.VisualStringList
* @see ir.donbee.jade.gui.ServiceDscDlg
* @see ir.donbee.jade.domain.FIPAAgentManagement.ServiceDescription
...
public class VisualServicesList extends VisualStringList
{
  ...
  */
  boolean checkSlots;
	...
	VisualServicesList(ir.donbee.jade.util.leap.Iterator content, Component owner)
	{
		super(content,owner);
		checkSlots = true;
	}
