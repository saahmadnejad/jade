...
import ir.donbee.jade.core.AgentManager;
...
class PlatformControllerImpl implements PlatformController {
	...
	PlatformControllerImpl(ContainerController c, AgentManager m) {
		...
		myMain.addListener(new AgentManagerListenerAdapter() {
			public void removedContainer(ir.donbee.jade.core.event.PlatformEvent ev) {
	...
	/**
	 ...
	 all the methods of the ir.donbee.jade.core.AgentManager.Listener interface
	 */
	class AgentManagerListenerAdapter implements AgentManager.Listener {
		
		public void addedContainer(ir.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void removedContainer(ir.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void bornAgent(ir.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void deadAgent(ir.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void movedAgent(ir.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void suspendedAgent(ir.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void resumedAgent(ir.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void frozenAgent(ir.donbee.jade.core.event.PlatformEvent ev) {
		}
		public void thawedAgent(ir.donbee.jade.core.event.PlatformEvent ev) {
		}
		
		public void addedMTP(ir.donbee.jade.core.event.MTPEvent ev) {
		}
		public void removedMTP(ir.donbee.jade.core.event.MTPEvent ev) {
		}
		public void messageIn(ir.donbee.jade.core.event.MTPEvent ev) {
		}
		public void messageOut(ir.donbee.jade.core.event.MTPEvent ev) {
		}
	} // END of inner class AgentManagerListenerAdapter	  
	
	/**
	 Inner class ListenerWrapper
	 This utility class wraps a ir.donbee.jade.wrapper.PlatformController.Listener
	 into a ir.donbee.jade.core.AgentManager.Listener
	 */
		...
		public void removedContainer(ir.donbee.jade.core.event.PlatformEvent ev) {
			...
			try {
				if (cid.getName().equals(myContainer.getContainerName())) {
					// The local main container is terminating -->
					// The whole platform is terminating
					myListener.killedPlatform(new ir.donbee.jade.wrapper.PlatformEvent() {
