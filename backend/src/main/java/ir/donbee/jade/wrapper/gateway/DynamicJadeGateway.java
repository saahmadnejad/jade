...
import ir.donbee.jade.util.Event;
import ir.donbee.jade.util.Logger;
import ir.donbee.jade.util.leap.Properties;
import ir.donbee.jade.wrapper.AgentController;
import ir.donbee.jade.wrapper.ContainerController;
import ir.donbee.jade.wrapper.ControllerException;
import ir.donbee.jade.wrapper.StaleProxyException;
...
public class DynamicJadeGateway {
	 ...
	 * @see ir.donbee.jade.wrapper.AgentController#putO2AObject(Object, boolean)
	 **/
	 ...
	 * @param jadeProfile the properties that contain all parameters for running JADE (see ir.donbee.jade.core.Profile).
