...
public interface AgentController {
	...
	/**
	     ...
	     @see ir.donbee.jade.wrapper.Agent#putO2AObject(Object, boolean)
	 */
	public static final boolean ASYNC = false;
	/**
	     Constant representing a synchronous rendez-vous policy.
	     @see ir.donbee.jade.wrapper.Agent#putO2AObject(Object o, boolean blocking)
	 */
	...
	/**
	     ...
	     <code>ir.donbee.jade.core.Agent.getO2AObject()</code> method. The agent
	     ...
	     @see ir.donbee.jade.core.Agent#getO2AObject()
	 ...
	 * @see ir.donbee.jade.core.Agent#registerO2AInterface(Class<T> theClass, T theInterface)
	 */
