...
public class EnvelopeHelper {
    ...
    public static void write(org.omg.CORBA.portable.OutputStream out, Envelope that) {
	{
	    ...
	    for (int __index = 0 ; __index < that.to.length ; __index += 1) {
	        AgentIDHelper.write(out, that.to[__index]);
	    }
	}
	{
	    ...
	    for (int __index = 0 ; __index < that.from.length ; __index += 1) {
	        AgentIDHelper.write(out, that.from[__index]);
	    }
	}
	...
	out.write_string(that.payloadEncoding);
	{
	    ...
	    for (int __index = 0 ; __index < that.date.length ; __index += 1) {
	        DateTimeHelper.write(out, that.date[__index]);
	    }
	}
	{
	...
	}
	{
	    ...
	    for (int __index = 0 ; __index < that.intendedReceiver.length ; __index += 1) {
	        AgentIDHelper.write(out, that.intendedReceiver[__index]);
	    }
	}
	{
	    ...
	    for (int __index = 0 ; __index < that.received.length ; __index += 1) {
	        ReceivedObjectHelper.write(out, that.received[__index]);
	    }
	}
	{
	    ...
	    for (int __index = 0 ; __index < that.transportBehaviour.length ; __index += 1) {
	        ...
	        for (int __index2 = 0 ; __index2 < that.transportBehaviour[__index].length ; __index2 += 1) {
	            PropertyHelper.write(out, that.transportBehaviour[__index][__index2]);
	        }
	    }
	}
	{
    ...
    public static Envelope read(org.omg.CORBA.portable.InputStream in) {
        Envelope that = new Envelope();
	{
	    int __length = in.read_long();
	    that.to = new AgentID[__length];
	    for (int __index = 0 ; __index < that.to.length ; __index += 1) {
	        that.to[__index] = AgentIDHelper.read(in);
	    }
	}
	{
	    int __length = in.read_long();
	    ...
	    that.from = new AgentID[__length];
	    for (int __index = 0 ; __index < that.from.length ; __index += 1) {
	        that.from[__index] = AgentIDHelper.read(in);
	    }
	}
	...
	that.payloadEncoding = in.read_string();
	{
	    ...
	    that.date = new DateTime[__length];
	    for (int __index = 0 ; __index < that.date.length ; __index += 1) {
	        that.date[__index] = DateTimeHelper.read(in);
	    }
	}
	{
	    int __length = in.read_long();
	...
	{
	    int __length = in.read_long();
	    that.intendedReceiver = new AgentID[__length];
	    for (int __index = 0 ; __index < that.intendedReceiver.length ; __index += 1) {
	        that.intendedReceiver[__index] = AgentIDHelper.read(in);
	    }
	}
	{
	    int __length = in.read_long();
	    ...
	    that.received = new ReceivedObject[__length];
	    for (int __index = 0 ; __index < that.received.length ; __index += 1) {
	        that.received[__index] = ReceivedObjectHelper.read(in);
	    }
	}
	{
	    int __length = in.read_long();
	    ...
	    that.transportBehaviour = new Property[__length][];
	    for (int __index = 0 ; __index < that.transportBehaviour.length ; __index += 1) {
	        int __length2 = in.read_long();
	        that.transportBehaviour[__index] = new Property[__length2];
	        for (int __index2 = 0 ; __index2 < that.transportBehaviour[__index].length ; __index2 += 1) {
	            that.transportBehaviour[__index][__index2] = PropertyHelper.read(in);
	        }
	    }
	}
	{
       ...
       org.omg.CORBA.StructMember[] _members = null;
          if (_tc == null) {
               ...
               _members[1] = new org.omg.CORBA.StructMember(
                 "from",
                 org.omg.CORBA.ORB.init().create_sequence_tc((int) (1L), AgentIDHelper.type()),
                 null);
               ...
               _members[6] = new org.omg.CORBA.StructMember(
                 "date",
                 org.omg.CORBA.ORB.init().create_sequence_tc((int) (1L), DateTimeHelper.type()),
                 null);
               ...
               _members[9] = new org.omg.CORBA.StructMember(
                 "received",
                 org.omg.CORBA.ORB.init().create_sequence_tc((int) (1L), ReceivedObjectHelper.type()),
                 null);

               _members[10] = new org.omg.CORBA.StructMember(
                 "transportBehaviour",
                 org.omg.CORBA.ORB.init().create_sequence_tc((int) (1L), org.omg.CORBA.ORB.init().create_sequence_tc(0, PropertyHelper.type())),
                 null);
